...
Shader "Custom/IA/Portal"
{
	Properties
	{
		...
		_UseRender("UseRender", Range( 0 , 1)) = 1
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 temp_output_108_0 = ( lerpResult70 + ( _Color3 * saturate( ( ( 1.0 - ( ( tex2DNode89.a * _CenterGradiant ) + tex2D( _TextureSample1, lerpResult124.rg ).r ) ) * tex2DNode89.a ) ) ) );
			float2 uv_PortalRender = i.uv_texcoord * _PortalRender_ST.xy + _PortalRender_ST.zw;
			float4 Albedo62 = temp_output_108_0;
			float4 lerpResult139 = lerp( tex2D( _PortalRender, uv_PortalRender ) , Albedo62 , tex2DNode83.a);
			float4 lerpResult140 = lerp( temp_output_108_0 , lerpResult139 , _UseRender);
			o.Albedo = lerpResult140.rgb;
			o.Emission = Albedo62.rgb;
			o.Alpha = 1;
			clip( saturate( ( ( tex2DNode83.a + tex2DNode89.a ) + ( tex2DNode89.a * ( 1.0 - _OpacityCenter ) ) ) ) - _Cutoff );
		}
...
/*ASEBEGIN
Version=18900
155;402;671;570;1310.967;447.4248;2.136659;True;False
Node;AmplifyShaderEditor.SamplerNode;100;-4500.777,623.4791;Inherit;True;Property;_FlowMap;FlowMap;8;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;f039d4efae7db944d8ed64056cb2363b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;97;-3331.35,638.2983;Inherit;False;Property;_RotationSpeed;RotationSpeed;7;0;Create;True;0;0;0;False;0;False;0;0.58;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;103;-3064.741,782.8684;Inherit;False;Property;_SecondFlowMap;SecondFlowMap;9;0;Create;True;0;0;0;False;0;False;0.21;0.1243822;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;127;-2144.813,1138.865;Inherit;False;Property;_Float0;Float 0;13;0;Create;True;0;0;0;False;0;False;0;0.2155638;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;128;-2645.553,1012.827;Inherit;True;Property;_TextureSample2;Texture Sample 2;8;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;100;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;115;-1618.983,809.3947;Inherit;False;Property;_CenterGradiant;CenterGradiant;12;0;Create;True;0;0;0;False;0;False;0.9;0.86;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;105;-1783.243,925.4604;Inherit;True;Property;_TextureSample1;Texture Sample 1;10;0;Create;True;0;0;0;False;0;False;-1;None;872f743a53ae7c44cb30c0f71fd5181e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;120;-1570.355,613.4357;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;113;-1393.644,605.6709;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;76;-1562.972,-39.04941;Inherit;False;Property;_Color1;Color 1;4;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;7.428699,0,41.73181,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;111;-1366.423,174.5262;Inherit;False;Property;_Color3;Color 3;11;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.4745096,0,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;72;-1572.134,-242.9194;Inherit;False;Property;_Color0;Color 0;3;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0.1778975,0,0.6792453,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;83;-1925.677,362.9874;Inherit;True;Property;_Circle;Circle;5;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;1c4456cfc4cdda04aae855b1449d517e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;112;-1049.915,572.8492;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;133;-1078.144,480.4449;Inherit;False;Property;_OpacityCenter;OpacityCenter;14;0;Create;True;0;0;0;False;0;False;0;1.158846;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;137;-868.1093,-0.7740123;Inherit;True;Property;_PortalRender;PortalRender;15;0;Create;True;0;0;0;False;0;False;-1;None;23713b70eb90bd84a9d3f411b230fae8;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;139;-542.8708,-51.83383;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;142;-653.7925,-276.6528;Inherit;False;Property;_UseRender;UseRender;16;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;140;-392.7767,-201.4075;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SaturateNode;136;-740.6085,143.859;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-246.3419,-7.711143;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;Custom/IA/Portal;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;0;True;TransparentCutout;;Transparent;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;139;1;62;0
WireConnection;139;2;83;4
...
ASEEND*/
//CHKSM=4345D34425F148BB0FBF7EA4EDD45437F55B3E96