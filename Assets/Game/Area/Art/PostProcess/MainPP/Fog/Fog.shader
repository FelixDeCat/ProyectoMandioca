...
Shader "Hidden/Fog"
{
	Properties
	{
		...
		_RadiusFogPP("RadiusFogPP", Float) = 15
		_FallOfFogPP("FallOfFogPP", Float) = 5
	...
	SubShader
	{
		...
		Pass
		{
			...
			uniform float _RadiusFogPP;
			uniform float _FallOfFogPP;
			...
			float4 Frag (ASEVaryingsDefault i  ) : SV_Target
			{
				...
				float FogMask10 = saturate( pow( ( eyeDepth3 / _RadiusFogPP ) , ( 1.0 - _FallOfFogPP ) ) );
...
/*ASEBEGIN
Version=18900
0;444;1149;377;2027.149;-151.6898;1.978469;True;False
Node;AmplifyShaderEditor.RangedFloatNode;12;-909.0699,755.2394;Inherit;False;Property;_FallOfFogPP;FallOfFogPP;2;0;Create;True;0;0;0;False;0;False;5;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;9;-949.6747,626.0241;Inherit;False;Property;_RadiusFogPP;RadiusFogPP;1;0;Create;True;0;0;0;False;0;False;15;15;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=02B3EF7AA354CAB2BCE342A227C8B7ACAA279878