...
Shader "Custom/Test/TestBoogers"
{
	Properties
	{
		...
		_ColorPolis("ColorPolis", Color) = (0,0,0,0)
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_8_0_g20 = ase_vertex3Pos;
			...
			float2 temp_output_5_0_g19 = i.uv_texcoord;
			float2 panner3_g19 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_output_5_0_g19);
			float4 lerpResult7_g19 = lerp( tex2D( _FlowTexture1, panner3_g19 ) , float4( temp_output_5_0_g19, 0.0 , 0.0 ) , _MaskFlowMap1);
			float3 tex2DNode4_g18 = UnpackScaleNormal( tex2D( _Normal1, lerpResult7_g19.rg ), _NormalIntensity1 );
			float3 Normal37 = BlendNormals( worldToTangentPos7_g20 , tex2DNode4_g18 );
			o.Normal = Normal37;
			float3 ase_worldPos = i.worldPos;
			float3 ase_worldViewDir = normalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			float fresnelNdotV6_g18 = dot( (WorldNormalVector( i , tex2DNode4_g18 )), ase_worldViewDir );
			float fresnelNode6_g18 = ( 0.0 + 5.0 * pow( 1.0 - fresnelNdotV6_g18, _PowerFresnel ) );
			float4 lerpResult12_g18 = lerp( _MainColor1 , _SecondColor1 , saturate( fresnelNode6_g18 ));
			float grayscale10_g20 = Luminance(worldToTangentPos7_g20);
			float4 lerpResult14_g18 = lerp( lerpResult12_g18 , _ColorPolis , saturate( grayscale10_g20 ));
			float4 Emission38 = lerpResult14_g18;
...
/*ASEBEGIN
Version=18900
0;442;1145;379;3319.34;977.5651;3.519628;True;False
...
Node;AmplifyShaderEditor.ColorNode;45;-1670.18,-872.3616;Inherit;False;Property;_ColorPolis;ColorPolis;15;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-1266.981,533.23;Inherit;False;Property;_Amplitude;Amplitude;1;0;Create;True;0;0;0;False;0;False;0;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;34;-1867.774,-114.0361;Inherit;False;Property;_SecondColor1;Second Color;14;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.2923707,0,0.3113208,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;35;-1896.493,-291.2037;Inherit;False;Property;_MainColor1;Main Color;13;1;[Header];Create;True;1;Color;0;0;False;0;False;0,0,0,0;0.3105235,0,0.3584906,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;30;-1948.341,-491.5704;Inherit;True;Property;_FlowTexture1;FlowTexture;17;2;[Header];[NoScaleOffset];Create;True;1;FlowMap;0;0;False;0;False;None;f039d4efae7db944d8ed64056cb2363b;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;44;-1669.909,-806.5325;Inherit;False;Property;_PowerFresnel;PowerFresnel;16;0;Create;True;0;0;0;False;0;False;0;3.74;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;33;-1968.256,-821.6347;Inherit;False;Property;_MaskFlowMap1;MaskFlowMap;19;0;Create;True;0;0;0;False;0;False;0;0.7;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;46;-1515.94,-584.9002;Inherit;False;CorruptionEnviroment;5;;18;f19c0caae5b61504da6375bc75dcb966;0;8;28;COLOR;0,0,0,0;False;25;FLOAT;0;False;18;FLOAT;0;False;19;FLOAT;0;False;20;SAMPLER2D;0;False;24;SAMPLER2D;;False;21;COLOR;0,0,0,0;False;22;COLOR;0,0,0,0;False;2;COLOR;0;FLOAT3;23
...
Node;AmplifyShaderEditor.RangedFloatNode;41;-346.5871,144.6279;Inherit;False;Property;_Metallic1;Metallic;18;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;42;-354.5855,242.8399;Inherit;False;Property;_Smoothness1;Smoothness;20;0;Create;True;0;0;0;False;0;False;0;0.198;0;1;0;1;FLOAT;0
...
WireConnection;46;28;45;0
WireConnection;46;25;44;0
WireConnection;46;18;33;0
WireConnection;46;19;32;0
WireConnection;46;20;31;0
WireConnection;46;24;30;0
WireConnection;46;21;35;0
WireConnection;46;22;34;0
WireConnection;10;0;27;0
WireConnection;10;1;8;0
WireConnection;12;0;10;0
WireConnection;12;1;2;1
WireConnection;38;0;46;0
WireConnection;37;0;46;23
...
ASEEND*/
//CHKSM=C237014A5D622EB4F13E6135D03AA632538F0D2D