...
Shader "Style/New/LowPolyBaseEnemy"
{
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif //aseld
			float dotResult10 = dot( (WorldNormalVector( i , worldToTangentPos7_g1 )) , ase_worldlightDir );
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			float4 ase_lightColor = 0;
			#else //aselc
			float4 ase_lightColor = _LightColor0;
			#endif //aselc
			float4 CustomLighting16 = ( (dotResult10*_Scale + _Offset) * ( i.vertexColor * float4( ( ase_lightColor.rgb * ase_lightAtten ) , 0.0 ) ) );
...
/*ASEBEGIN
Version=17200
0;415;1021;274;582.8658;14.8766;1.063079;True;False
...
Node;AmplifyShaderEditor.WorldPosInputsNode;1;-2109.892,423.8112;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FunctionNode;2;-1946.194,421.1922;Inherit;False;NewLowPolyStyle;-1;;1;9366fbf697958664ea2b821af5ab3369;0;1;8;FLOAT3;0,0,0;False;2;FLOAT;9;FLOAT3;0
...
ASEEND*/
//CHKSM=108445246E0B186148E810D1770BE57F91BD71FE