...
Shader "Style/New/Base"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float mulTime9_g80 = _Time.y * _SpeedWind;
			...
			float WindMask4_g80 = TextureMaskWind236;
			float clampResult23_g80 = clamp( ( cos( ( ( ase_vertex3Pos.x * _FreqWind ) + mulTime9_g80 ) ) * _IntensityWind * ( WindMask4_g80 + ( ( 1.0 - WindMask4_g80 ) * ase_vertex3Pos.y * _MaskWind ) ) ) , -1.0 , 1.0 );
			#ifdef _USEWIND_ON
				float3 staticSwitch248 = ( float3(1,0,0) * clampResult23_g80 );
			#else
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_8_0_g75 = ase_worldPos;
			float3 normalizeResult5_g75 = normalize( cross( ddy( temp_output_8_0_g75 ) , ddx( temp_output_8_0_g75 ) ) );
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 worldToTangentPos7_g75 = mul( ase_worldToTangent, normalizeResult5_g75);
			float3 LowPolyNormal11_g74 = worldToTangentPos7_g75;
			float3 normalizeResult5_g74 = normalize( LowPolyNormal11_g74 );
			float2 uv_Normal180 = i.uv_texcoord;
			float3 Normal223 = UnpackNormal( tex2D( _Normal, uv_Normal180 ) );
			float3 Normal9_g74 = BlendNormals( normalizeResult5_g74 , Normal223 );
			o.Normal = Normal9_g74;
			#if defined(LIGHTMAP_ON) && UNITY_VERSION < 560 //aseld
			float3 ase_worldlightDir = 0;
			#else //aseld
			float3 ase_worldlightDir = normalize( UnityWorldSpaceLightDir( ase_worldPos ) );
			#endif //aseld
			float dotResult27_g74 = dot( (WorldNormalVector( i , LowPolyNormal11_g74 )) , ase_worldlightDir );
			...
			float4 Albedo37_g74 = ( (dotResult27_g74*_ScaleLight + _OffsetLight) * ( float4( ase_lightColor.rgb , 0.0 ) * Albedo221 ) );
			o.Albedo = Albedo37_g74.xyz;
			float2 uv_Emission216 = i.uv_texcoord;
			float4 Emission218 = tex2D( _Emission, uv_Emission216 );
			float3 Emission46_g74 = ( Emission218.rgb + 0.0 );
			o.Emission = Emission46_g74;
			float2 uv_Smoothness206 = i.uv_texcoord;
			float Smoothness225 = tex2D( _Smoothness, uv_Smoothness206 ).r;
			float Smoothness43_g74 = ( Smoothness225 + _SmoothnessValue );
			o.Smoothness = Smoothness43_g74;
			o.Alpha = 1;
		}
...
Node;AmplifyShaderEditor.RangedFloatNode;246;286.8419,258.1589;Inherit;False;Property;_MaskWind;Mask Wind;18;0;Create;True;0;0;False;0;0;0.3647059;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;251;542.7516,346.7291;Inherit;False;Wind;1;;80;eed665e570e2c4748963a890bd063960;0;5;31;FLOAT;0;False;29;FLOAT;0;False;30;FLOAT;0;False;28;FLOAT;0;False;27;FLOAT;0;False;1;FLOAT3;26
...
Node;AmplifyShaderEditor.FunctionNode;232;601.434,-321.8303;Inherit;False;Base;-1;;74;e4e81f7df3e1c014c913bd5262530403;0;8;53;FLOAT;0;False;54;FLOAT;0;False;50;FLOAT3;0,0,0;False;52;FLOAT;0;False;39;FLOAT;0;False;42;FLOAT;0;False;34;FLOAT4;0,0,0,0;False;4;FLOAT3;0,0,0;False;4;FLOAT3;48;FLOAT;35;FLOAT4;8;FLOAT3;0
...
Node;AmplifyShaderEditor.StaticSwitch;248;776.2057,329.6505;Inherit;False;Property;_UseWind;Use Wind;17;0;Create;True;0;0;False;0;0;0;1;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;177;1001.566,-328.4899;Float;False;True;2;ASEMaterialInspector;0;0;Standard;Style/New/Base;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;177;2;232;48
WireConnection;177;4;232;35
WireConnection;177;11;248;0
ASEEND*/
//CHKSM=BC5C5B14CE2A17159C9BB2B3198A4822D555624D