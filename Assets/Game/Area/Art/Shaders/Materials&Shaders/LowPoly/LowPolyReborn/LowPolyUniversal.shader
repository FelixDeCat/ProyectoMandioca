...
Shader "Style/New/Base"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_8_0_g100 = ase_worldPos;
			float3 normalizeResult5_g100 = normalize( cross( ddy( temp_output_8_0_g100 ) , ddx( temp_output_8_0_g100 ) ) );
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 worldToTangentPos7_g100 = mul( ase_worldToTangent, normalizeResult5_g100);
			float3 LowPolyNormal11_g99 = worldToTangentPos7_g100;
			float3 normalizeResult5_g99 = normalize( LowPolyNormal11_g99 );
			float2 uv_Normal180 = i.uv_texcoord;
			float3 Normal223 = UnpackNormal( tex2D( _Normal, uv_Normal180 ) );
			float3 Normal9_g99 = BlendNormals( normalizeResult5_g99 , Normal223 );
			o.Normal = Normal9_g99;
			...
			float3 Emission46_g99 = ( Emission218.rgb * _EmissionIntensity );
			#ifdef _USEEMISSION_ON
				float3 staticSwitch252 = saturate( Emission46_g99 );
			#else
			...
			float Smoothness43_g99 = ( Smoothness225 + _SmoothnessValue );
			float temp_output_266_0 = saturate( Smoothness43_g99 );
...
/*ASEBEGIN
Version=17200
0;416;980;273;-704.9304;532.8992;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;278;492.186,-353.0986;Inherit;False;Base;-1;;99;7fb924c0b3c46a84fb4eaa069d41dc90;0;8;53;FLOAT;0;False;54;FLOAT;0;False;50;FLOAT3;0,0,0;False;52;FLOAT;0;False;39;FLOAT;0;False;42;FLOAT;0;False;34;FLOAT4;0,0,0,0;False;4;FLOAT3;0,0,0;False;4;FLOAT3;48;FLOAT;35;FLOAT4;8;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;251;544.1263,348.104;Inherit;False;Wind;8;;98;eed665e570e2c4748963a890bd063960;0;5;31;FLOAT;0;False;29;FLOAT;0;False;30;FLOAT;0;False;28;FLOAT;0;False;27;FLOAT;0;False;1;FLOAT3;26
...
WireConnection;278;53;229;0
WireConnection;278;54;230;0
WireConnection;278;50;220;0
WireConnection;278;52;267;0
WireConnection;278;39;226;0
WireConnection;278;42;189;0
WireConnection;278;34;222;0
WireConnection;278;4;224;0
WireConnection;236;0;235;1
WireConnection;266;0;278;35
...
ASEEND*/
//CHKSM=FB24A54E137526E92CF0B5F1A5A3D4C6938E1B70