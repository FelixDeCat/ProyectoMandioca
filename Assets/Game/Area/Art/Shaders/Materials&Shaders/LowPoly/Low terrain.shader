...
Shader "Style/LowPoly"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float temp_output_9_0_g48 = _Freq;
			float mulTime5_g48 = _Time.y * 1.5;
			float temp_output_8_0_g48 = _Ammount;
			float temp_output_6_0_g48 = ( cos( ( ( ase_vertex3Pos.y * temp_output_9_0_g48 ) + mulTime5_g48 ) ) * temp_output_8_0_g48 );
			float4 appendResult10_g48 = (float4(temp_output_6_0_g48 , 0.0 , temp_output_6_0_g48 , 0.0));
			float4 break16_g48 = mul( appendResult10_g48, UNITY_MATRIX_M );
			float4 appendResult17_g48 = (float4(break16_g48.x , 0.0 , break16_g48.z , 0.0));
			float3 rotatedValue13_g48 = RotateAroundAxis( float3( 0,0,0 ), appendResult17_g48.xyz, float3( 0,0,0 ), _Dir );
			float3 Wind79 = ( rotatedValue13_g48 * ( ase_vertex3Pos.y + _Float2 ) );
			v.vertex.xyz += Wind79;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float2 clipScreen440 = ase_screenPosNorm.xy * _ScreenParams.xy;
			float dither440 = Dither4x4Bayer( fmod(clipScreen440.x, 4), fmod(clipScreen440.y, 4) );
			...
			c.a = 1;
			clip( step( dither440 , _Intensity ) - _Cutoff );
			return c;
		}
...
/*ASEBEGIN
Version=17200
0;381;977;308;-12728.11;18.58114;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;98;2113.418,426.8905;Inherit;False;Property;_OffsetShadow;OffsetShadow;11;0;Create;True;0;0;False;0;0;0.87;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;97;2132.549,339.7563;Inherit;False;Property;_ScaleShadow;ScaleShadow;10;0;Create;True;0;0;False;0;0;0.74;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;330;3296.216,595.8859;Inherit;False;Property;_ValueShadow;ValueShadow;16;0;Create;True;0;0;False;0;0;1.52;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;62;3390.983,2340.345;Inherit;False;Property;_Freq;Freq;1;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;417;3381.721,2401.29;Inherit;True;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;61;3389.76,2281.607;Inherit;False;Property;_Ammount;Ammount;7;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;419;3526.573,2581.853;Inherit;False;Property;_Float2;Float 2;24;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;60;3391.408,2218.42;Inherit;False;Property;_Dir;Dir;6;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;327;3407.021,691.3132;Inherit;False;Property;_ColorShadow;ColorShadow;17;0;Create;True;0;0;False;0;1,0.9643341,0.6462264,0;1,0.8426101,0.8160377,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;418;3712.327,2422.742;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;-0.27;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;437;3544.411,2263.2;Inherit;False;Wind;-1;;48;eed665e570e2c4748963a890bd063960;0;4;36;FLOAT3;0,0,0;False;15;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;2;FLOAT3;43;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;416;4049.244,2276.233;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;79;4230.336,2274.587;Inherit;False;Wind;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;368;12592.83,185.7928;Inherit;False;Property;_Intensity;Intensity;23;0;Create;True;0;0;False;0;0;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.DitheringNode;440;12707.24,111.9631;Inherit;False;0;False;3;0;FLOAT;0;False;1;SAMPLER2D;;False;2;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;80;8874.395,302.2376;Inherit;False;79;Wind;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.PowerNode;361;9987.68,468.8072;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.PosVertexDataNode;393;11331.19,268.5954;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;279;11643.75,414.9492;Inherit;False;Property;_DistanceCamera;DistanceCamera;4;0;Create;True;0;0;False;0;0;10.09;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;396;11815.65,300.3689;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;278;11589.71,340.478;Inherit;False;Property;_FallOffCamera;FallOffCamera;2;0;Create;True;0;0;False;0;0;3.84;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CameraDepthFade;392;11897.78,276.0361;Inherit;False;3;2;FLOAT3;0,0,0;False;0;FLOAT;1;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StepOpNode;367;12888.76,114.7132;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;341;9811.458,621.1605;Inherit;False;Property;_IntensityDither;IntensityDither;18;0;Create;True;0;0;False;0;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;365;11458.32,40.69078;Inherit;True;Property;_TextureSample0;Texture Sample 0;22;1;[HideInInspector];Create;True;0;0;False;0;-1;None;479e8f8118033cb41b8aeca24300824b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;362;9810.683,559.8071;Inherit;False;Property;_Float1;Float 1;21;0;Create;True;0;0;False;0;0;48.36;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;430;3317.869,2567.281;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;437;15;60;0
WireConnection;437;8;61;0
WireConnection;437;9;62;0
...
WireConnection;0;10;367;0
WireConnection;0;13;386;0
WireConnection;0;11;387;0
ASEEND*/
//CHKSM=5396FFE2B91F91253C3225DA1373DDF3D1854CEC