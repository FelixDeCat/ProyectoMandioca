...
Shader "Style/LowPoly"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float mulTime5_g17 = _Time.y * 1.5;
			float temp_output_6_0_g17 = ( cos( ( ( ase_vertex3Pos.y * _Freq ) + mulTime5_g17 ) ) * _Ammount );
			float4 appendResult10_g17 = (float4(temp_output_6_0_g17 , 0.0 , temp_output_6_0_g17 , 0.0));
			float4 break16_g17 = mul( appendResult10_g17, UNITY_MATRIX_M );
			float4 appendResult17_g17 = (float4(break16_g17.x , 0.0 , break16_g17.z , 0.0));
			float3 rotatedValue13_g17 = RotateAroundAxis( float3( 0,0,0 ), appendResult17_g17.xyz, float3( 0,0,0 ), _Dir );
			float3 Wind79 = rotatedValue13_g17;
			v.vertex.xyz += Wind79;
		}
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 temp_output_8_0_g16 = ase_worldPos;
			...
			#endif //aseld
			float dotResult89 = dot( (WorldNormalVector( i , worldToTangentPos7_g16 )) , ase_worldlightDir );
			...
			float4 lerpResult186 = lerp( ( float4( ase_lightColor.rgb , 0.0 ) * NewColor264 * _ShadoColor ) , NewColor264 , clampResult182);
			float4 Shadows211 = lerpResult186;
			float4 temp_output_225_0 = ( float4( IluminationCalculate94 , 0.0 ) * Shadows211 );
			c.rgb = temp_output_225_0.rgb;
			c.a = 1;
			return c;
		}
...
/*ASEBEGIN
Version=17200
0;362;974;327;-2776.897;-614.0015;4.297542;True;False
Node;AmplifyShaderEditor.WorldPosInputsNode;263;5384.963,593.8139;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.FunctionNode;256;5749.355,729.8384;Inherit;False;NewLowPolyStyle;-1;;18;9366fbf697958664ea2b821af5ab3369;0;1;8;FLOAT3;0,0,0;False;2;FLOAT;9;FLOAT3;0
Node;AmplifyShaderEditor.VertexColorNode;255;5818.863,544.1071;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;267;1487.251,39.64222;Inherit;False;NewLowPolyStyle;-1;;16;9366fbf697958664ea2b821af5ab3369;0;1;8;FLOAT3;0,0,0;False;2;FLOAT;9;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;97;2132.549,339.7563;Inherit;False;Property;_ScaleShadow;ScaleShadow;10;0;Create;True;0;0;False;0;0;0.41;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;194;2831.01,751.8525;Inherit;False;Property;_ShadoColor;ShadoColor;13;0;Create;True;0;0;False;0;0,0,0,0;0,0.0658263,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;62;3262.122,2392.978;Inherit;False;Property;_Freq;Freq;3;0;Create;True;0;0;False;0;0;37.99;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;117;3544.411,2263.2;Inherit;False;Wind;-1;;17;eed665e570e2c4748963a890bd063960;0;4;25;FLOAT;0;False;15;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;95;6008.269,-194.3539;Inherit;False;94;IluminationCalculate;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;212;6045.661,-101.8134;Inherit;False;211;Shadows;1;0;OBJECT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.PosVertexDataNode;251;5605.714,185.4751;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;225;6311.332,-174.2282;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;252;6550.007,118.4231;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.VertexColorNode;253;6335.077,275.3882;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;250;6073.712,200.0759;Inherit;False;NewLowPolyStyle;-1;;19;9366fbf697958664ea2b821af5ab3369;0;1;8;FLOAT3;0,0,0;False;2;FLOAT;9;FLOAT3;0
...
Node;AmplifyShaderEditor.PosVertexDataNode;254;5375.539,711.3445;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;248;6482.827,-0.1415353;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.PosVertexDataNode;268;1163.573,-53.59768;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=4DCFC55D1FAF00B20D00855F5DECCEF2BDA87A59