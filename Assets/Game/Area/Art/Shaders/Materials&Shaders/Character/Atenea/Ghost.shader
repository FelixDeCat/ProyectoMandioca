	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 lerpResult293 = lerp( float4( uv0201, 0.0 , 0.0 ) , tex2D( _FlowTexture, uv0290 ) , _Flow);
				float2 uv0210 = i.ase_texcoord1.xy * float2( 0.5,0.5 ) + float2( 0,0 );
				float2 uv0285 = i.ase_texcoord1.xy * float2( 1,1 ) + Panner203;
				float4 lerpResult287 = lerp( float4( uv0210, 0.0 , 0.0 ) , tex2D( _FlowTexture, uv0285 ) , _Flow);
				float2 uv0213 = i.ase_texcoord1.xy * float2( 0.2,0.2 ) + Panner203;
				float2 uv0277 = i.ase_texcoord1.xy * float2( 1,1 ) + Panner203;
				float4 lerpResult275 = lerp( float4( uv0213, 0.0 , 0.0 ) , tex2D( _FlowTexture, uv0277 ) , _Flow);
...
/*ASEBEGIN
Version=18301
0;392;945;297;2258.966;1968.139;8.677775;True;False
...
Node;AmplifyShaderEditor.SamplerNode;288;1970.685,-676.2366;Inherit;True;Property;_FlowMap;FlowMap;1;1;[HideInInspector];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;291;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;274;2000.783,-278.019;Inherit;True;Property;_TextureSample4;Texture Sample 4;1;1;[HideInInspector];Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;291;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;230;3832.654,554.3129;Inherit;False;Property;_MainColor;Main Color;10;0;Create;True;0;0;False;0;False;0,0,0,0;0.0705879,0.6945841,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=DADBBB08980DD7D0A948471CB38E484FDB52E425