...
Shader "Terrain/Test"
{
	Properties
	{
		...
		_Color0("Color 0", Color) = (0.03127098,1,0,0)
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult19_g1 = lerp( _Color0 , float4( 0,0,0,0 ) , clampResult20_g1);
...
/*ASEBEGIN
Version=17200
0;400;974;289;1331.697;-119.949;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;3;-872.1146,142.8466;Inherit;False;Property;_MoveMask;MoveMask;0;0;Create;True;0;0;False;0;0;0.08;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-849.4703,-98.2292;Inherit;False;Property;_Float0;Float 0;1;0;Create;True;0;0;False;0;0;-0.92;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;4;-937.6615,206.9346;Inherit;False;Property;_Color0;Color 0;2;0;Create;True;0;0;False;0;0.03127098,1,0,0;0,0.9622641,0.01920122,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;5;-975.5707,385.1274;Inherit;False;Property;_Color1;Color 1;3;0;Create;True;0;0;False;0;0.6132076,0.202687,0,0;0.6630843,1,0.5424528,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=0D4B041EFF5D172AAEBEDC52E69C25482C702678