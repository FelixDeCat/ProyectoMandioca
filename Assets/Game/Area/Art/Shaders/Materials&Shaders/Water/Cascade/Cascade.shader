...
Shader "Effects/Water/Cascade"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float3 temp_cast_0 = (( ( ( tex2Dlod( _TextureSample1, float4( uv_TextureSample1, 0, 0.0) ).r + -0.04 ) * tex2Dlod( _TextureSample0, float4( panner17, 0, 0.0) ).r ) * ( 1.0 - ase_vertexNormal.y ) * ( 1.0 - _CascadeIntensity ) )).xxx;
...
/*ASEBEGIN
Version=17200
0;389;940;300;395.9186;-531.2504;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;71;-631.7737,99.56883;Inherit;False;Property;_Float0;Float 0;11;0;Create;True;0;0;False;0;0;0.925;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;77;-544.156,364.8696;Inherit;False;Constant;_Mask;Mask;10;0;Create;True;0;0;False;0;-0.04;-0.04;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;76;-316.956,256.6696;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;-0.22;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;25;-126.044,-614.6826;Inherit;False;Property;_Color0;Color 0;8;0;Create;True;0;0;False;0;1,1,1,0;0.2688674,0.9256109,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;24;-174.1129,802.1794;Inherit;False;Property;_CascadeIntensity;CascadeIntensity;12;0;Create;True;0;0;False;0;0;2.87;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-117.1996,428.9203;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=732B7A99264BE16DB4CB7F4B337D20A80D4E735E