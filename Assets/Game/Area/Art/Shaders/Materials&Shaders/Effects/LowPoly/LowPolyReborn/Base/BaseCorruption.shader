...
Shader "Style/New/Corruption"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult57 = lerp( tex2D( _Corruption, uv_TexCoord56 ) , CalculateContrast(_ColorSaturation,( Albedo9 * _TintColor )) , saturate( ( ( ( tex2D( _Mask, uv_TexCoord42 ) * 2.0 ) * ( 1.0 - pow( localDistance53 , _Float0 ) ) ) / ( 1.0 - _SizeCorruption ) ) ));
...
/*ASEBEGIN
Version=17200
0;416;974;273;625.2248;-695.6597;1;True;False
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;56;-302.4716,779.0858;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;5,5;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=20466A6FFCB7A1E83B4617BB028FB2028CFE06CF