...
Shader "Style/New/Corruption"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 lerpResult57 = lerp( tex2D( _Corruption, uv_TexCoord56 ) , CalculateContrast(_ColorSaturation,( Albedo9 * _TintColor )) , saturate( ( ( ( tex2D( _Mask, uv_TexCoord42 ) * 2.0 ) * ( 1.0 - localDistance53 ) ) / ( 1.0 - _Size ) ) ));
...
/*ASEBEGIN
Version=17200
0;409;942;280;1184.691;-4.456812;2.78183;True;False
...
ASEEND*/
//CHKSM=93E492E7957634E702AE7D024AB696E476690676