...
/*ASEBEGIN
Version=17200
0;409;942;280;885.8117;-1207.71;1.075815;True;False
Node;AmplifyShaderEditor.WorldPosInputsNode;52;-878.2003,1217.91;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.GlobalArrayNode;51;-894.387,1400.039;Inherit;False;positionsArray;0;40;2;False;False;0;1;False;Object;-1;4;0;INT;0;False;2;INT;0;False;1;INT;0;False;3;INT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.CustomExpressionNode;53;-547.4154,1302.928;Inherit;False;float closest=10000@$float now=0@$for(int i=0@ i<positionsArray.Length@i++){$	now = distance(WorldPos,positionsArray[i])@$	if(now < closest){$	closest = now@$	}$}$return closest@;1;False;2;True;WorldPos;FLOAT3;0,0,0;In;;Float;False;True;objectPosition;FLOAT3;0,0,0;In;;Float;False;Distance;True;False;0;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;45;372.4723,1270.263;Inherit;False;Property;_SizeCorruption;Size Corruption;16;0;Create;True;0;0;False;0;0;1.63;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=4EC7238AE0F872E494106E2B95FD5C9CCE34E489