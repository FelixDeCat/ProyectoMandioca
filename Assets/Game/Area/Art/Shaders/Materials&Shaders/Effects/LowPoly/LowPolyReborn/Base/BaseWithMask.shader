...
Shader "Style/New/BaseWithMask"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 LowPolyNormal11_g4 = worldToTangentPos7_g5;
			float3 normalizeResult5_g4 = normalize( LowPolyNormal11_g4 );
			float2 uv_Normal3 = i.uv_texcoord;
			float3 Normal13 = UnpackNormal( tex2D( _Normal, uv_Normal3 ) );
			float3 Normal9_g4 = BlendNormals( normalizeResult5_g4 , Normal13 );
			float3 NormalConnection48 = Normal9_g4;
			...
			#endif //aseld
			float dotResult27_g4 = dot( (WorldNormalVector( i , LowPolyNormal11_g4 )) , ase_worldlightDir );
			...
			float4 Albedo37_g4 = saturate( ( (dotResult27_g4*0.58 + 0.65) * ( float4( ase_lightColor.rgb , 0.0 ) * Albedo15 ) ) );
			...
			#endif
			float4 AlbedoConection46 = ( Albedo37_g4 + ( ( _MaskColor * Albedo15 ) * ( 1.0 - step( saturate( ( staticSwitch24 + _RangeMask ) ) , 0.0 ) ) ) );
			...
			float3 Emission46_g4 = ( Emission9.rgb * EmissionIntensity14 );
			float3 EmissionConection50 = saturate( Emission46_g4 );
			...
			float Smoothness43_g4 = ( Smoothness12 + SmoothnessValue10 );
			o.Smoothness = Smoothness43_g4;
			float2 uv_AO5 = i.uv_texcoord;
			float AmbientOcclusionTexturet11 = tex2D( _AO, uv_AO5 ).r;
			float AO66_g4 = AmbientOcclusionTexturet11;
			o.Occlusion = AO66_g4;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=17200
0;410;942;279;1674.954;6.894653;2.832797;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;27;-711.2632,-229.0415;Inherit;False;Property;_RangeMask;Range Mask;10;0;Create;True;0;0;False;0;0;-0.81;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-3282.436,175.4943;Inherit;False;Property;_SmoothnessValue;SmoothnessValue;8;0;Create;True;0;0;False;0;0;-1;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;30;-375.3859,-597.3046;Inherit;False;Property;_MaskColor;Mask Color;11;0;Create;True;0;0;False;0;0,0,0,0;0.5635404,1,0.3254717,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=37D3ACD1EAE91F540F0A0F83A55EB68A2CB13252