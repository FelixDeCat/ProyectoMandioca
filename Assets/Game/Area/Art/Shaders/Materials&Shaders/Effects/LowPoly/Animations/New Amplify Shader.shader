...
Shader "New Amplify Shader"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float mulTime5_g2 = _Time.y * 1.5;
			float temp_output_6_0_g2 = ( cos( ( ( ase_vertex3Pos.y * _Freq ) + mulTime5_g2 ) ) * _Ammount );
			float4 appendResult10_g2 = (float4(temp_output_6_0_g2 , 0.0 , temp_output_6_0_g2 , 0.0));
			float4 break16_g2 = mul( appendResult10_g2, unity_WorldToObject );
			float4 appendResult17_g2 = (float4(break16_g2.x , 0.0 , break16_g2.z , 0.0));
			float3 rotatedValue13_g2 = RotateAroundAxis( float3( 0,0,0 ), appendResult17_g2.xyz, float3( 0,0,0 ), _Dir );
			float3 Wind49 = rotatedValue13_g2;
			v.vertex.xyz += Wind49;
		}
...
/*ASEBEGIN
Version=17200
0;364;933;325;622.1627;82.24905;1;True;False
...
Node;AmplifyShaderEditor.ColorNode;30;-1702.072,990.8494;Inherit;False;Property;_ShadoColor;ShadoColor;13;0;Create;True;0;0;False;0;0,0,0,0;0.1718512,1,0.1254895,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;42;1087.441,1869.616;Inherit;False;Property;_Freq;Freq;0;0;Create;True;0;0;False;0;0;37.99;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;41;1100.475,1785.985;Inherit;False;Property;_Ammount;Ammount;5;0;Create;True;0;0;False;0;0;791.4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;87;1391.267,1600.418;Inherit;False;Wind;-1;;2;eed665e570e2c4748963a890bd063960;0;4;36;FLOAT3;0,0,0;False;15;FLOAT;0;False;8;FLOAT;0;False;9;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;50;-294.947,374.7085;Inherit;False;258;165;Wind Effect;1;62;;1,1,1,1;0;0
...
WireConnection;87;36;39;0
WireConnection;87;15;40;0
WireConnection;87;8;41;0
WireConnection;87;9;42;0
...
ASEEND*/
//CHKSM=C85D8BE0BF44C3559440A4E5751FD049CDDBA162