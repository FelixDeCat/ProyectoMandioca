...
Shader "Style/New/BaseDeformation"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 temp_output_21_0_g126 = PosPepito;
			float3 ase_worldPos = mul( unity_ObjectToWorld, v.vertex );
			float3 appendResult64 = (float3(( (( ( 1.0 - saturate( ( ( distance( temp_output_21_0_g126 , ase_worldPos ) / _Radius ) * _FallOff ) ) ) * ( ase_worldPos - temp_output_21_0_g126 ) )).xz * _Intensity ) , 0.0));
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_8_0_g124 = ase_worldPos;
			float3 normalizeResult5_g124 = normalize( cross( ddy( temp_output_8_0_g124 ) , ddx( temp_output_8_0_g124 ) ) );
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 worldToTangentPos7_g124 = mul( ase_worldToTangent, normalizeResult5_g124);
			float3 LowPolyNormal11_g123 = worldToTangentPos7_g124;
			float3 normalizeResult5_g123 = normalize( LowPolyNormal11_g123 );
			float2 uv_Normal30 = i.uv_texcoord;
			float3 Normal31 = UnpackNormal( tex2D( _Normal, uv_Normal30 ) );
			float3 Normal9_g123 = BlendNormals( normalizeResult5_g123 , Normal31 );
			o.Normal = Normal9_g123;
			...
			float3 Emission46_g123 = ( Emission37.rgb * EmissionIntensity25 );
			#ifdef _USEEMISSION_ON
				float3 staticSwitch47 = saturate( Emission46_g123 );
			#else
			...
			float temp_output_39_0_g123 = Smoothness35;
			float SmoothnessValue26 = _SmoothnessValue;
			float Smoothness43_g123 = ( temp_output_39_0_g123 * SmoothnessValue26 );
			float temp_output_38_0 = saturate( Smoothness43_g123 );
			...
			float AO66_g123 = AmbientOcclusionTexturet29;
			o.Occlusion = pow( AO66_g123 , _AOIntensity );
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18301
0;388;953;301;1464.844;-647.9946;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;27;-2865.947,244.662;Inherit;False;Property;_SmoothnessValue;SmoothnessValue;12;0;Create;True;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;57;-1610.241,634.089;Inherit;False;Global;PosPepito;PosPepito;19;0;Create;True;0;0;False;0;False;640.7247,81.94778,-221.6727;635.6337,81.97775,-219.4884;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;9;-1519.674,904.4325;Inherit;False;Property;_FallOff;Fall Off;3;0;Create;True;0;0;False;0;False;0;0.51;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;8;-1527.442,840.9964;Inherit;False;Property;_Radius;Radius;2;0;Create;True;0;0;False;0;False;0;0.72;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-1533.89,781.3098;Inherit;False;Property;_Intensity;Intensity;4;0;Create;True;0;0;False;0;False;0;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;79;-1313.995,714.0861;Inherit;False;Deformation;-1;;126;166fa67aec49d264981c8969b12f5dfc;0;4;21;FLOAT3;0,0,0;False;20;FLOAT;0;False;22;FLOAT;0;False;23;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;15;-995.0438,-67.53646;Inherit;False;Base;-1;;123;7fb924c0b3c46a84fb4eaa069d41dc90;0;7;74;FLOAT;0;False;67;FLOAT;0;False;50;FLOAT3;0,0,0;False;52;FLOAT;0;False;39;FLOAT;0;False;42;FLOAT;0;False;4;FLOAT3;0,0,0;False;5;FLOAT;69;FLOAT;64;FLOAT3;48;FLOAT;35;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;11;-723.6614,717.9736;Inherit;False;Deformation;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;79;21;57;0
WireConnection;79;20;10;0
WireConnection;79;22;8;0
WireConnection;79;23;9;0
...
ASEEND*/
//CHKSM=26091780DC27D1656DD248AA617E9FEBF4E62D27