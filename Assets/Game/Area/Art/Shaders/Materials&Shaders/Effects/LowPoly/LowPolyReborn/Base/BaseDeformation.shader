...
Shader "Style/New/BaseDeformation"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 temp_output_21_0_g122 = PosPepito;
			float3 ase_worldPos = mul( unity_ObjectToWorld, v.vertex );
			float3 appendResult64 = (float3(( (( ( 1.0 - saturate( ( ( distance( temp_output_21_0_g122 , ase_worldPos ) / _Radius ) * _FallOff ) ) ) * ( ase_worldPos - temp_output_21_0_g122 ) )).xz * _Intensity ) , 0.0));
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_8_0_g120 = ase_worldPos;
			float3 normalizeResult5_g120 = normalize( cross( ddy( temp_output_8_0_g120 ) , ddx( temp_output_8_0_g120 ) ) );
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 worldToTangentPos7_g120 = mul( ase_worldToTangent, normalizeResult5_g120);
			float3 LowPolyNormal11_g119 = worldToTangentPos7_g120;
			float3 normalizeResult5_g119 = normalize( LowPolyNormal11_g119 );
			float2 uv_Normal30 = i.uv_texcoord;
			float3 Normal31 = UnpackNormal( tex2D( _Normal, uv_Normal30 ) );
			float3 Normal9_g119 = BlendNormals( normalizeResult5_g119 , Normal31 );
			o.Normal = Normal9_g119;
			...
			float3 Emission46_g119 = ( Emission37.rgb * EmissionIntensity25 );
			#ifdef _USEEMISSION_ON
				float3 staticSwitch47 = saturate( Emission46_g119 );
			#else
			...
			float temp_output_39_0_g119 = Smoothness35;
			float SmoothnessValue26 = _SmoothnessValue;
			float Smoothness43_g119 = ( temp_output_39_0_g119 * SmoothnessValue26 );
			float temp_output_38_0 = saturate( Smoothness43_g119 );
			...
			float AO66_g119 = AmbientOcclusionTexturet29;
			o.Occlusion = pow( AO66_g119 , _AOIntensity );
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18301
0;388;953;301;1403.263;115.1684;2.85933;True;False
Node;AmplifyShaderEditor.RangedFloatNode;24;-2797.407,493.6546;Inherit;False;Property;_EmissionIntensity;Emission Intensity;11;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;27;-2865.947,244.662;Inherit;False;Property;_SmoothnessValue;SmoothnessValue;12;0;Create;True;0;0;False;0;False;0;-1;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-1533.89,781.3098;Inherit;False;Property;_Intensity;Intensity;4;0;Create;True;0;0;False;0;False;0;0.36;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;57;-1610.241,634.089;Inherit;False;Global;PosPepito;PosPepito;19;0;Create;True;0;0;False;0;False;640.7247,81.94778,-221.6727;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;9;-1519.674,904.4325;Inherit;False;Property;_FallOff;Fall Off;3;0;Create;True;0;0;False;0;False;0;0.9;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-1527.442,840.9964;Inherit;False;Property;_Radius;Radius;2;0;Create;True;0;0;False;0;False;0;0.73;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;74;-1313.995,714.0861;Inherit;False;Deformation;-1;;122;166fa67aec49d264981c8969b12f5dfc;0;4;21;FLOAT3;0,0,0;False;20;FLOAT;0;False;22;FLOAT;0;False;23;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;40;-321.5461,-430.6023;Inherit;False;Property;_TintColor;Tint Color;14;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;15;-995.0438,-67.53646;Inherit;False;Base;-1;;119;7fb924c0b3c46a84fb4eaa069d41dc90;0;7;74;FLOAT;0;False;67;FLOAT;0;False;50;FLOAT3;0,0,0;False;52;FLOAT;0;False;39;FLOAT;0;False;42;FLOAT;0;False;4;FLOAT3;0,0,0;False;5;FLOAT;69;FLOAT;64;FLOAT3;48;FLOAT;35;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;39;-412.7659,382.968;Inherit;False;Property;_MetalicIntensity;Metalic Intensity;10;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;45;-269.9351,121.6762;Inherit;False;Property;_AOIntensity;AO Intensity;13;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-74.41504,-201.5999;Inherit;False;Property;_ColorSaturation;Color Saturation;18;0;Create;True;0;0;False;0;False;1;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;11;-951.6614,719.9736;Inherit;False;Deformation;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;43;-387.4183,-102.3702;Inherit;False;Property;_EmissionColor;Emission Color;15;1;[HDR];Create;True;0;0;False;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;12;-21.46276,460.9708;Inherit;False;11;Deformation;1;0;OBJECT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;61;-1310.777,606.99;Inherit;False;PlayerPos;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-1232.879,-105.0695;Inherit;False;Property;_OffsetLight;Offset Light;17;0;Create;True;0;0;False;0;False;0;8.17;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-1246.229,-158.9711;Inherit;False;Property;_ScaleLight;Scale Light;16;0;Create;True;0;0;False;0;False;0.24;3.03;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;240.9685,92.57556;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;Style/New/BaseDeformation;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;74;21;57;0
WireConnection;74;20;10;0
WireConnection;74;22;8;0
WireConnection;74;23;9;0
...
ASEEND*/
//CHKSM=D3178F7330AD78D0CA8D87124CAEF5D2A904DCD3