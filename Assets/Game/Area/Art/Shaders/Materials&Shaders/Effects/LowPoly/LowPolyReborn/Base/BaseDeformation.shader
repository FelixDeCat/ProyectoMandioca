...
Shader "Style/New/BaseDeformation"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 temp_output_21_0_g118 = PosPepito;
			float3 ase_worldPos = mul( unity_ObjectToWorld, v.vertex );
			float3 appendResult64 = (float3(( (( ( 1.0 - saturate( ( ( distance( temp_output_21_0_g118 , ase_worldPos ) / _Radius ) * _FallOff ) ) ) * ( ase_worldPos - temp_output_21_0_g118 ) )).xz * _Intensity ) , 0.0));
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_8_0_g117 = ase_worldPos;
			float3 normalizeResult5_g117 = normalize( cross( ddy( temp_output_8_0_g117 ) , ddx( temp_output_8_0_g117 ) ) );
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 worldToTangentPos7_g117 = mul( ase_worldToTangent, normalizeResult5_g117);
			float3 LowPolyNormal11_g116 = worldToTangentPos7_g117;
			float3 normalizeResult5_g116 = normalize( LowPolyNormal11_g116 );
			float2 uv_Normal30 = i.uv_texcoord;
			float3 Normal31 = UnpackNormal( tex2D( _Normal, uv_Normal30 ) );
			float3 Normal9_g116 = BlendNormals( normalizeResult5_g116 , Normal31 );
			o.Normal = Normal9_g116;
			...
			float3 Emission46_g116 = ( Emission37.rgb * EmissionIntensity25 );
			#ifdef _USEEMISSION_ON
				float3 staticSwitch47 = saturate( Emission46_g116 );
			#else
			...
			float temp_output_39_0_g116 = Smoothness35;
			float SmoothnessValue26 = _SmoothnessValue;
			float Smoothness43_g116 = ( temp_output_39_0_g116 * SmoothnessValue26 );
			float temp_output_38_0 = saturate( Smoothness43_g116 );
			...
			float AO66_g116 = AmbientOcclusionTexturet29;
			o.Occlusion = pow( AO66_g116 , _AOIntensity );
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18301
0;388;953;301;2146.641;-553.89;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-1600.687,839.8337;Inherit;False;Property;_Radius;Radius;2;0;Create;True;0;0;False;0;False;0;0.73;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-1595.509,766.1958;Inherit;False;Property;_Intensity;Intensity;4;0;Create;True;0;0;False;0;False;0;0.13;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;9;-1592.919,903.2698;Inherit;False;Property;_FallOff;Fall Off;3;0;Create;True;0;0;False;0;False;0;0.9;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;57;-1857.878,703.8458;Inherit;False;Global;PosPepito;PosPepito;19;0;Create;True;0;0;False;0;False;640.7247,81.94778,-221.6727;640.3009,69.84985,-238.4424;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.FunctionNode;69;-1313.995,714.0861;Inherit;False;Deformation;-1;;118;166fa67aec49d264981c8969b12f5dfc;0;4;21;FLOAT3;0,0,0;False;20;FLOAT;0;False;22;FLOAT;0;False;23;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;64;-991.6788,703.6716;Inherit;False;FLOAT3;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;15;-995.0438,-67.53646;Inherit;False;Base;-1;;116;7fb924c0b3c46a84fb4eaa069d41dc90;0;7;74;FLOAT;0;False;67;FLOAT;0;False;50;FLOAT3;0,0,0;False;52;FLOAT;0;False;39;FLOAT;0;False;42;FLOAT;0;False;4;FLOAT3;0,0,0;False;5;FLOAT;69;FLOAT;64;FLOAT3;48;FLOAT;35;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;11;-812.9775,712.3382;Inherit;False;Deformation;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;12;409.9572,286.1784;Inherit;False;11;Deformation;1;0;OBJECT;0;False;1;FLOAT3;0
...
WireConnection;69;21;57;0
WireConnection;69;20;10;0
WireConnection;69;22;8;0
WireConnection;69;23;9;0
...
ASEEND*/
//CHKSM=20C63DF66D57083CB401938534A74D7E59331F35