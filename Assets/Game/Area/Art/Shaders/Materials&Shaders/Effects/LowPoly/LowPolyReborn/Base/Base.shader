...
Shader "Style/New/Base"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_8_0_g115 = ase_worldPos;
			float3 normalizeResult5_g115 = normalize( cross( ddy( temp_output_8_0_g115 ) , ddx( temp_output_8_0_g115 ) ) );
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 worldToTangentPos7_g115 = mul( ase_worldToTangent, normalizeResult5_g115);
			float3 LowPolyNormal11_g114 = worldToTangentPos7_g115;
			float3 normalizeResult5_g114 = normalize( LowPolyNormal11_g114 );
			float2 uv_Normal180 = i.uv_texcoord;
			float3 Normal223 = UnpackNormal( tex2D( _Normal, uv_Normal180 ) );
			float3 Normal9_g114 = BlendNormals( normalizeResult5_g114 , Normal223 );
			o.Normal = Normal9_g114;
			...
			float3 Emission46_g114 = ( Emission218.rgb * EmissionIntensity280 );
			#ifdef _USEEMISSION_ON
				float3 staticSwitch252 = saturate( Emission46_g114 );
			#else
				float3 staticSwitch252 = temp_cast_1;
			#endif
			o.Emission = ( float4( staticSwitch252 , 0.0 ) * _EmissionColor ).rgb;
			float2 uv_Metallic314 = i.uv_texcoord;
			float MetallicTexture316 = tex2D( _Metallic, uv_Metallic314 ).r;
			float Metallic70_g114 = ( MetallicTexture316 * _MetalicIntensity );
			o.Metallic = Metallic70_g114;
			...
			float Smoothness43_g114 = ( Smoothness225 * SmoothnessValue282 );
			#ifdef _USESMOOTHNESS_ON
				float staticSwitch274 = saturate( Smoothness43_g114 );
			#else
			...
			float AO66_g114 = AmbientOcclusionTexturet292;
			o.Occlusion = pow( AO66_g114 , _AOIntensity );
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18301
0;408;970;281;1347.974;1040.175;6.48652;True;False
Node;AmplifyShaderEditor.SamplerNode;206;-1682.55,-598.5008;Inherit;True;Property;_Smoothness;Smoothness;7;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;f57a0135274bc224fab96ef5d337fe9a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;267;-1455.488,609.2086;Inherit;False;Property;_EmissionIntensity;Emission Intensity;12;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;189;-1524.028,360.2161;Inherit;False;Property;_SmoothnessValue;SmoothnessValue;11;0;Create;True;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;317;131.8003,-575.3754;Inherit;False;316;MetallicTexture;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;294;81.57635,-414.8033;Inherit;False;292;AmbientOcclusionTexturet;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;276;136.0207,-479.6656;Inherit;False;Property;_MetalicIntensity;Metalic Intensity;10;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;286;943.7921,-870.9993;Inherit;False;Property;_TintColor;Tint Color;14;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;277;930.6143,-930.7763;Inherit;False;221;Albedo;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;313;462.5426,-406.9425;Inherit;False;Base;-1;;114;7fb924c0b3c46a84fb4eaa069d41dc90;0;8;72;FLOAT;0;False;74;FLOAT;0;False;67;FLOAT;0;False;50;FLOAT3;0,0,0;False;52;FLOAT;0;False;39;FLOAT;0;False;42;FLOAT;0;False;4;FLOAT3;0,0,0;False;5;FLOAT;69;FLOAT;64;FLOAT3;48;FLOAT;35;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;289;738.7893,-679.9721;Inherit;False;Constant;_DefaultEmission;Default Emission;22;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;288;954.7617,-539.8118;Inherit;False;Property;_EmissionColor;Emission Color;15;1;[HDR];Create;True;0;0;False;0;False;0,0,0,0;0,0,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;305;1267.765,-639.0415;Inherit;False;Property;_ColorSaturation;Color Saturation;16;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;252;926.4977,-674.552;Inherit;False;Property;_UseEmission;Use Emission;1;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SaturateNode;266;983.6959,-131.752;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;300;1072.245,-315.7654;Inherit;False;Property;_AOIntensity;AO Intensity;13;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-509.0351,794.9984;Inherit;False;Constant;_FullOpacity;FullOpacity;4;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;5;-677.1339,923.0174;Inherit;False;Property;_Intensity;Intensity;9;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;274;1236.375,-243.9934;Inherit;False;Property;_UseSmoothness;Use Smoothness;2;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;301;1252.611,-375.6614;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;6;-304.1302,818.1202;Inherit;False;Property;_Usemasktodissolve;Use mask to dissolve;0;0;Create;True;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
WireConnection;313;72;317;0
WireConnection;313;74;276;0
WireConnection;313;67;294;0
WireConnection;313;50;220;0
WireConnection;313;52;281;0
WireConnection;313;39;226;0
WireConnection;313;42;283;0
WireConnection;313;4;224;0
WireConnection;252;1;289;0
WireConnection;252;0;313;48
WireConnection;266;0;313;35
...
WireConnection;177;3;313;69
WireConnection;177;4;274;0
WireConnection;177;5;301;0
ASEEND*/
//CHKSM=8C54763A312C212C90B333E6909A6724E1241743