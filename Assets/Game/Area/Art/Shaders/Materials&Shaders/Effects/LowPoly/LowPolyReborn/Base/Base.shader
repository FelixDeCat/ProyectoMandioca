...
Shader "Style/New/Base"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_8_0_g123 = ase_worldPos;
			float3 normalizeResult5_g123 = normalize( cross( ddy( temp_output_8_0_g123 ) , ddx( temp_output_8_0_g123 ) ) );
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 worldToTangentPos7_g123 = mul( ase_worldToTangent, normalizeResult5_g123);
			float3 LowPolyNormal11_g122 = worldToTangentPos7_g123;
			float3 normalizeResult5_g122 = normalize( LowPolyNormal11_g122 );
			float2 uv_Normal180 = i.uv_texcoord;
			float3 Normal223 = UnpackNormal( tex2D( _Normal, uv_Normal180 ) );
			float3 Normal9_g122 = BlendNormals( normalizeResult5_g122 , Normal223 );
			o.Normal = Normal9_g122;
			...
			float grayscale10_g123 = Luminance(worldToTangentPos7_g123);
			float LowPolyGrayscale13_g122 = grayscale10_g123;
			float3 Emission46_g122 = ( ( Emission218.rgb * EmissionIntensity280 ) + LowPolyGrayscale13_g122 );
			#ifdef _USEEMISSION_ON
				float3 staticSwitch252 = saturate( Emission46_g122 );
			#else
			...
			float temp_output_39_0_g122 = Smoothness225;
			float Metallic70_g122 = ( temp_output_39_0_g122 * _MetalicIntensity );
			o.Metallic = Metallic70_g122;
			float SmoothnessValue282 = _SmoothnessValue;
			float Smoothness43_g122 = ( temp_output_39_0_g122 * SmoothnessValue282 );
			#ifdef _USESMOOTHNESS_ON
				float staticSwitch274 = saturate( Smoothness43_g122 );
			#else
			...
			float AO66_g122 = AmbientOcclusionTexturet292;
			o.Occlusion = pow( AO66_g122 , _AOIntensity );
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18301
0;392;945;297;754.5508;882.6372;3.112448;True;False
Node;AmplifyShaderEditor.RangedFloatNode;267;-1455.488,609.2086;Inherit;False;Property;_EmissionIntensity;Emission Intensity;10;0;Create;True;0;0;False;0;False;0;72.24;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;293;-1627.228,69.76199;Inherit;True;Property;_AO;AO;5;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;9f6fa6584e212544db83e355c7b6fbe1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;216;-1478.046,-843.0775;Inherit;True;Property;_Emission;Emission;3;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;7ba8905708b19df4cbc93b56448ecd5c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;189;-1524.028,360.2161;Inherit;False;Property;_SmoothnessValue;SmoothnessValue;9;0;Create;True;0;0;False;0;False;0;1;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;206;-1511.2,-626.0012;Inherit;True;Property;_Smoothness;Smoothness;6;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;c9c449ce1a9e41a4a83ed3d8aae5467f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;185;-1336.537,-416.7673;Inherit;True;Property;_Albedo;Albedo;2;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;bc211709fc2560b489e3c0751bdc84fd;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;294;34.36237,-391.7454;Inherit;False;292;AmbientOcclusionTexturet;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;276;76.72878,-552.1337;Inherit;False;Property;_MetalicIntensity;Metalic Intensity;8;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;220;152.1285,-350.0488;Inherit;False;218;Emission;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;286;847.0449,868.0998;Inherit;False;Property;_TintColor;Tint Color;12;0;Create;True;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;331;401.8676,-413.5016;Inherit;False;Base;-1;;122;7fb924c0b3c46a84fb4eaa069d41dc90;0;7;74;FLOAT;0;False;67;FLOAT;0;False;50;FLOAT3;0,0,0;False;52;FLOAT;0;False;39;FLOAT;0;False;42;FLOAT;0;False;4;FLOAT3;0,0,0;False;5;FLOAT;69;FLOAT;64;FLOAT3;48;FLOAT;35;FLOAT3;0
...
Node;AmplifyShaderEditor.SaturateNode;266;779.9101,14.97383;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;305;1072.187,937.8395;Inherit;False;Property;_ColorSaturation;Color Saturation;14;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;252;840.7311,-959.726;Inherit;False;Property;_UseEmission;Use Emission;0;0;Create;True;0;0;False;0;False;0;0;1;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;284;746.9897,-84.60783;Inherit;False;282;SmoothnessValue;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;288;868.9951,-824.9858;Inherit;False;Property;_EmissionColor;Emission Color;13;1;[HDR];Create;True;0;0;False;0;False;0,0,0,0;0.3584906,0,0.3416205,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;274;968.5898,-79.66756;Inherit;False;Property;_UseSmoothness;Use Smoothness;1;0;Create;True;0;0;False;0;False;0;0;1;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;302;1226.485,-503.3874;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;324;1253.605,14.02131;Inherit;False;SmoothnessNode;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;300;1295.051,-177.191;Inherit;False;Property;_AOIntensity;AO Intensity;11;0;Create;True;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;322;1591.235,-512.1731;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;331;74;276;0
WireConnection;331;67;294;0
WireConnection;331;50;220;0
WireConnection;331;52;281;0
WireConnection;331;39;226;0
WireConnection;331;42;283;0
WireConnection;331;4;224;0
WireConnection;266;0;331;35
WireConnection;252;1;289;0
WireConnection;252;0;331;48
...
WireConnection;326;0;331;64
WireConnection;302;0;331;0
...
WireConnection;322;0;302;0
WireConnection;177;0;319;0
WireConnection;177;1;322;0
WireConnection;177;2;321;0
WireConnection;177;3;331;69
WireConnection;177;4;325;0
WireConnection;177;5;328;0
ASEEND*/
//CHKSM=50F3F3A399BA4BBBB17B2F82336B8DDC6DE34988