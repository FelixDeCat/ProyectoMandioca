...
Shader "Style/New/BaseWithWind"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float mulTime9_g134 = _Time.y * _SpeedWind;
			float temp_output_28_0_g134 = _IntensityWind;
			float2 uv_WindMask8 = v.texcoord;
			float MaskWind9 = tex2Dlod( _WindMask, float4( uv_WindMask8, 0, 0.0) ).r;
			float WindMask4_g134 = MaskWind9;
			float temp_output_18_0_g134 = ( WindMask4_g134 + ( ( 1.0 - WindMask4_g134 ) * ase_vertex3Pos.y * _MaskWind ) );
			float clampResult23_g134 = clamp( ( cos( ( ( ase_vertex3Pos.x * _FreqWind ) + mulTime9_g134 ) ) * temp_output_28_0_g134 * temp_output_18_0_g134 ) , -1.0 , 1.0 );
			float3 Wind44 = ( float3(1,0,0) * clampResult23_g134 );
			v.vertex.xyz += Wind44;
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_8_0_g125 = ase_worldPos;
			float3 normalizeResult5_g125 = normalize( cross( ddy( temp_output_8_0_g125 ) , ddx( temp_output_8_0_g125 ) ) );
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 worldToTangentPos7_g125 = mul( ase_worldToTangent, normalizeResult5_g125);
			float3 LowPolyNormal11_g124 = worldToTangentPos7_g125;
			float3 normalizeResult5_g124 = normalize( LowPolyNormal11_g124 );
			float2 uv_Normal34 = i.uv_texcoord;
			float3 Normal38 = UnpackNormal( tex2D( _Normal, uv_Normal34 ) );
			float3 Normal9_g124 = BlendNormals( normalizeResult5_g124 , Normal38 );
			o.Normal = Normal9_g124;
			...
			float3 Emission46_g124 = ( Emission40.rgb * EmissionIntensity42 );
			#ifdef _USEEMISSION_ON
				float3 staticSwitch21 = saturate( Emission46_g124 );
			#else
			...
			float temp_output_39_0_g124 = Smoothness43;
			float MetallicValue56 = _MetallicIntensity;
			float Metallic70_g124 = ( temp_output_39_0_g124 * MetallicValue56 );
			o.Metallic = Metallic70_g124;
			...
			float AO66_g124 = AmbientOcclusionTexturet49;
			o.Occlusion = AO66_g124;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18301
0;378;1019;311;1775.016;-342.5011;1.889687;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;5;-1097.992,557.1814;Inherit;False;Property;_FreqWind;Freq Wind;15;0;Create;True;0;0;False;0;False;1.21;1.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;4;-1100.216,627.085;Inherit;False;Property;_SpeedWind;Speed Wind;14;0;Create;True;0;0;False;0;False;2.2;2.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;83;-1116.496,289.295;Inherit;True;Property;_NoiseWind;Noise Wind;11;1;[NoScaleOffset];Create;True;0;0;False;0;False;None;85b0fe455db181d4ebd25c8a834985e1;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.GetLocalVarNode;6;-1045.729,760.8622;Inherit;False;9;MaskWind;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;7;-1128.755,484.0106;Inherit;False;Property;_MaskWind;Mask Wind;16;0;Create;True;0;0;False;0;False;0;0.174;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3;-1134.773,674.5139;Inherit;False;Property;_IntensityWind;Intensity Wind;18;0;Create;True;0;0;False;0;False;0;0.061;0;0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;89;-716.2085,559.4578;Inherit;False;Wind;5;;134;eed665e570e2c4748963a890bd063960;0;6;36;SAMPLER2D;0;False;31;FLOAT;0;False;29;FLOAT;0;False;30;FLOAT;0;False;28;FLOAT;0;False;27;FLOAT;0;False;1;FLOAT3;26
...
Node;AmplifyShaderEditor.FunctionNode;46;-1725.512,-630.0049;Inherit;False;Base;-1;;124;7fb924c0b3c46a84fb4eaa069d41dc90;0;7;74;FLOAT;0;False;67;FLOAT;0;False;50;FLOAT3;0,0,0;False;52;FLOAT;0;False;39;FLOAT;0;False;42;FLOAT;0;False;4;FLOAT3;0,0,0;False;5;FLOAT;69;FLOAT;64;FLOAT3;48;FLOAT;35;FLOAT3;0
...
WireConnection;89;36;83;0
WireConnection;89;31;7;0
WireConnection;89;29;5;0
WireConnection;89;30;4;0
WireConnection;89;28;3;0
WireConnection;89;27;6;0
...
ASEEND*/
//CHKSM=1D34DD83E8E434E8427D2393CB8A1A3EF84F4CB6