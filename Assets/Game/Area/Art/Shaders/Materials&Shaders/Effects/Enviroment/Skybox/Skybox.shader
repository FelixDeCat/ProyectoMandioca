	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 tex2DNode274 = tex2D( _TextureSample1, ( ( UVSkybox26 * _Vector1 ) + _Vector0 ) );
				float4 lerpResult275 = lerp( ( ( ( SkyBoxBase64 * _IntensitySkyBox ) + Sun66 ) + Clouds144 ) , CalculateContrast(_Float6,tex2DNode274) , tex2DNode274.a);
				
				
				finalColor = lerpResult275;
				return finalColor;
			}
			ENDCG
		}
...
/*ASEBEGIN
Version=18301
0;413;1089;276;-1006.192;-5.729202;1.32606;True;False
...
WireConnection;193;0;275;0
ASEEND*/
//CHKSM=F7C307E41757AC06F8ED0FDE7CA803AD267CB64E