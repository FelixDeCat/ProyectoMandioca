...
Shader "Custom/Decals/DecalRunes"
{
	Properties
	{
		...
		[Header(Mask)][NoScaleOffset]_Mask("Mask", 2D) = "white" {}
	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float lerpResult35 = lerp( SAMPLE_TEXTURE2D_ARRAY( _AtlasRunes, sampler_AtlasRunes, float3(temp_output_23_0.xy,(float)_RuneIndex) ).a , 0.0 , saturate( ( tex2D( _Mask, uv_Mask21 ).r * (0.0 + (_MaskIntensity - 0.0) * (100.0 - 0.0) / (1.0 - 0.0)) ) ));
...
/*ASEBEGIN
Version=18900
0;390;1118;431;899.5913;325.4319;2.19891;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;118;-2770.08,433.4072;Inherit;False;Property;_Float0;Float 0;13;1;[Header];Create;True;1;NO TOCAR ESTE PARAMETRO;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;116;-2355.756,423.1615;Inherit;False;Property;_SizeY;Size Y;8;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;11;-2382.483,214.0365;Inherit;False;Property;_SizeX;Size X;7;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;110;-1588.421,-439.9431;Inherit;False;Property;_PosRunes;Pos Runes;12;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.StaticSwitch;73;-1606.346,-582.0529;Inherit;False;Property;_FixY;Fix Y;0;0;Create;True;0;0;0;False;0;False;0;0;0;True;DIRECTIONAL_COOKIE;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT4;0,0,0,0;False;0;FLOAT4;0,0,0,0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;4;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;7;FLOAT4;0,0,0,0;False;8;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.SimpleMaxOpNode;18;-2085.386,272.9652;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;21;-1200.702,-314.9359;Inherit;True;Property;_Mask;Mask;2;2;[Header];[NoScaleOffset];Create;True;1;Mask;0;0;False;0;False;-1;None;e1d4affda974e204fa329d1672d5960a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;24;-1328.208,-447.7553;Inherit;False;Property;_TillingRunes;Tilling Runes;11;0;Create;True;1;UV;0;0;False;0;False;0,0;5,5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.IntNode;141;-1170.078,-708.2488;Inherit;False;Property;_RuneIndex;RuneIndex;9;0;Create;True;0;0;0;False;0;False;10;0;False;0;1;INT;0
...
ASEEND*/
//CHKSM=5FC6F6BA48055C94B08C0E5AE9C59E6813E560B0