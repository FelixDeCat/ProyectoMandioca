...
Shader "Effects/Water/Cascade"
{
	Properties
	{
		...
		_FoamMask1("Foam Mask", Float) = 0
		[HideInInspector]_TextureSample2("Texture Sample 1", 2D) = "white" {}
		_CascadeIntensity1("CascadeIntensity", Float) = 0
		[HideInInspector]_TextureSample4("Texture Sample 3", 2D) = "white" {}
		_MaskFlowmap1("Mask Flowmap", Range( 0 , 1)) = 0
		[HDR]_FoamColor1("Foam Color", Color) = (0,0,0,0)
		_MainColor1("Main Color", Color) = (1,0,0,0)
		[HDR]_FoamAreaColor1("Foam Area Color", Color) = (0,0,0,0)
		_TextureSample3("Texture Sample 2", 2D) = "white" {}
		_CascadeSpeed1("Cascade Speed", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		uniform float _CascadeSpeed1;
		uniform float _CascadeIntensity1;
		uniform sampler2D _TextureSample3;
		uniform sampler2D _TextureSample4;
		uniform float _MaskFlowmap1;
		uniform float4 _FoamColor1;
		uniform float _FoamMask1;
		uniform float4 _MainColor1;
		uniform float4 _FoamAreaColor1;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 appendResult313 = (float2(0.0 , _CascadeSpeed1));
			float2 panner317 = ( 1.0 * _Time.y * appendResult313 + v.texcoord.xy);
			float3 ase_vertexNormal = v.normal.xyz;
			float LocalVertexOffset336 = ( ( tex2Dlod( _TextureSample2, float4( uv_TextureSample2, 0, 0.0) ).r * tex2Dlod( _TextureSample1, float4( panner317, 0, 0.0) ).r ) * ( 1.0 - ase_vertexNormal.y ) * ( 1.0 - _CascadeIntensity1 ) );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 Normal337 = worldToTangentPos7_g2;
			o.Normal = Normal337;
			float2 panner290 = ( 1.0 * _Time.y * float2( 0.15,0 ) + i.uv_texcoord);
			float2 panner291 = ( 1.0 * _Time.y * float2( 0,0.09 ) + i.uv_texcoord);
			float2 lerpResult300 = lerp( (tex2D( _TextureSample4, panner290 )).rg , panner291 , _MaskFlowmap1);
			float4 FoamTexture311 = ( ( 1.0 - tex2D( _TextureSample3, lerpResult300 ) ) * _FoamColor1 );
			float3 ase_vertexNormal = mul( unity_WorldToObject, float4( ase_worldNormal, 0 ) );
			float3 ase_normWorldNormal = normalize( ase_worldNormal );
			float dotResult299 = dot( ase_vertexNormal.y , ase_normWorldNormal.y );
			float smoothstepResult302 = smoothstep( _FoamMask1 , 1.0 , dotResult299);
			float FoamMask309 = ( 1.0 - smoothstepResult302 );
			float4 lerpResult320 = lerp( float4( 0,0,0,0 ) , FoamTexture311 , FoamMask309);
			float4 Albedo349 = ( ( lerpResult320 + ( _MainColor1 * ( 1.0 - FoamMask309 ) ) ) + ( FoamMask309 * _FoamAreaColor1 ) );
...
/*ASEBEGIN
Version=17200
0;416;976;273;257.3482;-983.3021;1.538594;True;False
...
Node;AmplifyShaderEditor.SamplerNode;292;-4.393982,1058.276;Inherit;True;Property;_TextureSample4;Texture Sample 3;9;1;[HideInInspector];Create;True;0;0;False;0;-1;None;f039d4efae7db944d8ed64056cb2363b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;293;66.43427,1405.316;Inherit;False;1;0;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ComponentMaskNode;294;262.7769,1070.11;Inherit;False;True;True;False;False;1;0;COLOR;0,0,0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;298;73.89655,1315.872;Inherit;False;Property;_MaskFlowmap1;Mask Flowmap;10;0;Create;True;0;0;False;0;0;0.8864931;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;301;-43.71805,697.4024;Inherit;False;Property;_FoamMask1;Foam Mask;3;0;Create;True;0;0;False;0;0;-10;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;303;584.7903,1042.768;Inherit;True;Property;_TextureSample3;Texture Sample 2;14;0;Create;True;0;0;False;0;-1;None;a3322b07ed43da646a1b1fca4e72fac1;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;304;264.7935,578.1526;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;305;946.0273,1370.24;Inherit;False;Property;_FoamColor1;Foam Color;11;1;[HDR];Create;True;0;0;False;0;0,0,0,0;1.411765,1.411765,1.411765,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;306;1073.581,1287.571;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;308;-3441.36,1222.082;Inherit;False;Property;_CascadeSpeed1;Cascade Speed;15;0;Create;True;0;0;False;0;0;0.2352941;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PannerNode;317;-2955.446,1121.673;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0.3;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;316;1738.298,978.7014;Inherit;False;Property;_MainColor1;Main Color;12;0;Create;True;0;0;False;0;1,0,0,0;0.4198111,0.7929521,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;318;1834.65,1372.869;Inherit;False;309;FoamMask;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;321;-2817.387,913.0553;Inherit;True;Property;_TextureSample2;Texture Sample 1;4;1;[HideInInspector];Create;True;0;0;False;0;-1;None;96a8252c1a35840459f69c10e67286e3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;325;-2670.575,1412.636;Inherit;False;Property;_CascadeIntensity1;CascadeIntensity;5;0;Create;True;0;0;False;0;0;6.42;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;319;-2805.452,1091.837;Inherit;True;Property;_TextureSample1;Texture Sample 0;1;1;[HideInInspector];Create;True;0;0;False;0;-1;None;38fc7d99d9c15324d92e6f1b77b0127e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;322;2218.943,1284.319;Inherit;False;Property;_FoamAreaColor1;Foam Area Color;13;1;[HDR];Create;True;0;0;False;0;0,0,0,0;0.8117648,0.8117648,0.8117648,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;337;-2315.061,367.863;Inherit;False;Normal;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;346;2359.018,857.2121;Inherit;False;336;LocalVertexOffset;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;347;2586.779,1662.467;Inherit;False;Property;_Float3;Float 2;6;0;Create;True;0;0;False;0;0;1.44;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;343;2338.845,756.6498;Inherit;False;Property;_Smoothness1;Smoothness;2;0;Create;True;0;0;False;0;0;0.6520824;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;340;644.1013,1360.644;Inherit;False;Property;_FoamSize1;Foam Size;8;0;Create;True;0;0;False;0;0;0.5401569;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;344;403.9474,1390.836;Inherit;False;Property;_FoamScale1;Foam Scale;7;0;Create;True;0;0;False;0;0;34.4;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=7A4E9D799B046E79972A746563E65F155B40B7F8