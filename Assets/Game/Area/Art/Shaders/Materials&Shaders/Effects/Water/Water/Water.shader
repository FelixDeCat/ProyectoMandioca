...
Shader "Effects/Water"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 coords1 = ( appendResult687 * _TileDefault ) * 1.0;
			float2 id1 = 0;
			float2 uv1 = 0;
			...
			float3 Waves42 = ( pow( voroi1 , _FallOFF ) * _Intensity * normalizeResult205 * ( 1.0 - ase_vertexNormal.y ) );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_152_0 = worldToTangentPos7_g6;
			...
			float3 Normal498 = BlendNormals( temp_output_152_0 , BlendNormals( UnpackScaleNormal( tex2D( _TextureSample0, lerpResult568.rg ), _NormalsScale ) , UnpackScaleNormal( tex2D( _TextureSample2, lerpResult568.rg ), _NormalsScale ) ) );
			o.Normal = Normal498;
			...
			float grayscale10_g6 = Luminance(worldToTangentPos7_g6);
			float Emission500 = saturate( ( grayscale10_g6 * _FacetIntenisty ) );
...
/*ASEBEGIN
Version=18301
0;416;954;273;-17.48859;223.1989;2.4504;True;False
Node;AmplifyShaderEditor.FunctionNode;785;866.3079,-165.9527;Inherit;False;UV World;-1;;7;1956765fd0afe43439f5eb3f4e9fd15d;0;2;4;FLOAT2;0,0;False;7;FLOAT2;0,0;False;3;FLOAT2;0;FLOAT;9;FLOAT;10
...
Node;AmplifyShaderEditor.RangedFloatNode;413;2042.299,77.13173;Inherit;False;Property;_NormalsScale;Normals Scale;11;0;Create;True;0;0;False;0;False;0.5;0.017;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;778;-1712.704,-775.1278;Inherit;False;UV World;-1;;5;1956765fd0afe43439f5eb3f4e9fd15d;0;2;4;FLOAT2;0,0;False;7;FLOAT2;-0.5,-0.5;False;3;FLOAT2;0;FLOAT;9;FLOAT;10
...
Node;AmplifyShaderEditor.FunctionNode;152;2531.834,-615.8514;Inherit;False;NewLowPolyStyle;-1;;6;9366fbf697958664ea2b821af5ab3369;0;1;8;FLOAT3;0,0,0;False;2;FLOAT;9;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;707;3916.285,2178.117;Inherit;False;Property;_FreqBigWave;Freq Big Wave;22;0;Create;True;0;0;False;0;False;0;61.03;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WorldPosInputsNode;681;-1305.338,-176.1776;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DynamicAppendNode;687;-1109.699,-143.7271;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;686;-1132.797,-36.62526;Inherit;False;Property;_TileDefault;Tile Default;21;0;Create;True;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;146;1550.001,-1237.273;Inherit;False;Property;_MainColor;Main Color;26;0;Create;True;0;0;False;0;False;0,0.4511628,0.5,0;0.1241504,0.301369,0.4433957,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;685;-942.3625,-61.72577;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;650;61.86629,-926.3705;Inherit;False;Property;_CollisionColor;Collision Color;27;0;Create;True;0;0;False;0;False;0.8784314,0.8784314,0.8784314,0;0,0.1164706,0.2358486,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;355;3153.46,1373.764;Inherit;False;Property;_FresnelColor;Fresnel Color;25;0;Create;True;0;0;False;0;False;0.4009434,0.5761672,1,0;0,0.3011926,0.367924,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;660;3534.575,651.3804;Inherit;False;Property;_DeformationIntensity;Deformation Intensity;13;0;Create;True;0;0;False;0;False;0;0.185;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.VoronoiNode;1;-712.9439,-32.56435;Inherit;True;0;1;1;3;1;False;1;False;False;4;0;FLOAT2;0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;3;FLOAT;0;FLOAT;1;FLOAT2;2
...
Node;AmplifyShaderEditor.RangedFloatNode;134;-674.129,210.24;Inherit;False;Property;_FallOFF;FallOFF;16;0;Create;True;0;0;False;0;False;0;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;722;4599.781,2247.836;Inherit;False;Property;_IntensityBigWave;Intensity Big Wave;24;0;Create;True;0;0;False;0;False;0;24.37;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;770;-429.753,449.9803;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;9;-446.757,253.7225;Inherit;False;Property;_Intensity;Intensity;14;0;Create;True;0;0;False;0;False;0;1.07;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;16;-427.638,143.0815;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=B4EBFFD578630682F9B5114863583E2A94C4F09D