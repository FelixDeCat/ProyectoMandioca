...
Shader "Effects/Water"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 Normal498 = BlendNormals( float3( 0,0,0 ) , BlendNormals( UnpackScaleNormal( tex2D( _TextureSample0, lerpResult568.rg ), _NormalsScale ) , UnpackScaleNormal( tex2D( _TextureSample2, lerpResult568.rg ), _NormalsScale ) ) );
			o.Normal = Normal498;
...
/*ASEBEGIN
Version=17200
0;409;976;280;-1328.097;636.8243;2.590666;True;False
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;500;3336.684,-611.1337;Inherit;False;Emission;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=17CC7D64DFDE08D13C8EF8AB66B6B13BC1483F23