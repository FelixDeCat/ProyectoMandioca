...
#define _IntensityWaves_arr EffectsWaterOcean
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float2 temp_output_6_0_g13 = ( ( appendResult2_g13 * appendResult47 ) + float2( 0,0 ) );
			float2 UVWorld57 = temp_output_6_0_g13;
			float2 panner205 = ( 1.0 * _Time.y * float2( 0.03,0 ) + UVWorld57);
			float Noise202 = tex2Dlod( _WavesTexture, float4( panner205, 0, 0.0) ).r;
			float2 appendResult2_g16 = (float2(ase_worldPos.x , ase_worldPos.z));
			float2 appendResult213 = (float2(0.59 , 0.21));
			float2 temp_output_6_0_g16 = ( ( appendResult2_g16 * appendResult213 ) + float2( 0,0 ) );
			float2 UVWorld2212 = temp_output_6_0_g16;
			float2 panner208 = ( 1.0 * _Time.y * float2( -0.07,0 ) + UVWorld2212);
			...
			v.vertex.xyz += ( Waves52 * float3(0,1,0) * _IntensityWaves_Instance );
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 Normal111 = BlendNormals( UnpackScaleNormal( tex2D( _NormalWaves, uv_NormalWaves77 ), _ScaleNormal ) , worldToTangentPos7_g15 );
			o.Normal = Normal111;
			float2 appendResult2_g13 = (float2(ase_worldPos.x , ase_worldPos.z));
			float2 appendResult47 = (float2(0.66 , 0.19));
			float2 temp_output_6_0_g13 = ( ( appendResult2_g13 * appendResult47 ) + float2( 0,0 ) );
			...
			float eyeDepth7_g14 = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, ase_screenPosNorm.xy ));
			float2 temp_output_21_0_g14 = ( (UnpackScaleNormal( tex2D( _NormalRefraction, panner199 ), 0.5 )).xy * ( _RefractionStrength / max( ase_screenDepth , 0.1 ) ) * saturate( ( eyeDepth7_g14 - ase_screenDepth ) ) );
			float eyeDepth26_g14 = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, ( float4( temp_output_21_0_g14, 0.0 , 0.0 ) + ase_screenPosNorm ).xy ));
			float2 temp_output_15_0_g14 = (( float4( ( temp_output_21_0_g14 * saturate( ( eyeDepth26_g14 - ase_screenDepth ) ) ), 0.0 , 0.0 ) + ase_screenPosNorm )).xy;
			float2 temp_output_10_0_g14 = ( ( floor( ( temp_output_15_0_g14 * (_CameraDepthTexture_TexelSize).zw ) ) + 0.5 ) * (_CameraDepthTexture_TexelSize).xy );
			float2 temp_output_109_0 = temp_output_10_0_g14;
			...
			float grayscale10_g15 = Luminance(worldToTangentPos7_g15);
			float Emission112 = ( grayscale10_g15 * _Facet );
...
/*ASEBEGIN
Version=18301
0;378;1019;311;654.0574;-1019.551;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;214;-4211.92,615.4102;Inherit;False;Constant;_TillingX2;Tilling X2;15;0;Create;True;0;0;False;0;False;0.59;0.59;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-4198.744,519.5321;Inherit;False;Constant;_TillingY;Tilling Y;7;0;Create;True;0;0;False;0;False;0.19;0.19;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;215;-4204.204,732.4151;Inherit;False;Constant;_TillingY2;Tilling Y2;16;0;Create;True;0;0;False;0;False;0.21;0.21;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;40;-3873.237,466.5197;Inherit;False;UV World;-1;;13;1956765fd0afe43439f5eb3f4e9fd15d;0;2;4;FLOAT2;0,0;False;7;FLOAT2;0,0;False;3;FLOAT2;0;FLOAT;9;FLOAT;10
...
Node;AmplifyShaderEditor.FunctionNode;211;-3862.22,637.135;Inherit;False;UV World;-1;;16;1956765fd0afe43439f5eb3f4e9fd15d;0;2;4;FLOAT2;0,0;False;7;FLOAT2;0,0;False;3;FLOAT2;0;FLOAT;9;FLOAT;10
Node;AmplifyShaderEditor.RangedFloatNode;116;-4239.267,2502.456;Inherit;False;Property;_RefractionStrength;Refraction Strength;8;0;Create;True;0;0;False;0;False;0;0.041;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;198;-4281.599,2284.572;Inherit;True;Property;_NormalRefraction;Normal Refraction;17;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;b95aaa7d1c88648499fca391b3005ca6;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0.5;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;109;-3944.185,2455.337;Inherit;False;DepthMaskRefraction;-1;;14;61527528047409b4d97706299350589d;2,27,0,4,0;2;18;FLOAT3;0,0,0;False;29;FLOAT;0.02;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;105;-2209.371,2219.201;Inherit;False;Property;_Depth;Depth;7;0;Create;True;0;0;False;0;False;0;0.406;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;158;-2152.039,2441.812;Inherit;False;Property;_DepthFoam;Depth Foam;6;0;Create;True;0;0;False;0;False;0;0.284;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;151;-6134.347,1568.798;Inherit;False;Property;_Facet;Facet;9;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;81;-6148.817,1482.749;Inherit;False;NewLowPolyStyle;-1;;15;9366fbf697958664ea2b821af5ab3369;0;1;8;FLOAT3;0,0,0;False;2;FLOAT;9;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;78;-6549.417,1316.588;Inherit;False;Property;_ScaleNormal;Scale Normal;10;0;Create;True;0;0;False;0;False;1;0.049;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;51;-663.9429,1366.303;Inherit;False;InstancedProperty;_IntensityWaves;Intensity Waves;12;0;Create;True;0;0;False;0;False;0;0.58;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;50;-669.4578,1180.68;Inherit;False;Constant;_DirWaves;Dir Waves;6;0;Create;True;0;0;False;0;False;0,1,0;0,1,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;217;-3550.195,83.22896;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;0.46,0.36;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;197;-457.9779,972.874;Inherit;False;Property;_Smoothness;Smoothness;11;0;Create;True;0;0;False;0;False;0;0.635;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;114;-445.8557,726.5362;Inherit;False;111;Normal;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;216;-3535.764,-187.1349;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;0.54,1.5;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-0.2902164,959.698;Float;False;True;-1;6;ASEMaterialInspector;0;0;Standard;Effects/Water/Ocean;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;0;False;Transparent;;Transparent;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;True;1;4;5;15;False;0.5;True;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=C4C4EFE7D6E0136BACF9BB44590D24491ABDA3AE