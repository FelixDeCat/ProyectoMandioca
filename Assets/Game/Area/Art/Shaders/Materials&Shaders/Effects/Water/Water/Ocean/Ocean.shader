...
#define _IntensityWaves_arr EffectsWaterOcean
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 appendResult2_g27 = (float2(ase_worldPos.x , ase_worldPos.z));
			float2 appendResult47 = (float2(_TillingX , _TillingY));
			float2 temp_output_6_0_g27 = ( ( appendResult2_g27 * appendResult47 ) + float2( 0,0 ) );
			float2 UVWorld57 = temp_output_6_0_g27;
			float2 panner205 = ( 1.0 * _Time.y * float2( 0.02,0 ) + UVWorld57);
			float Noise202 = tex2Dlod( _WavesTexture, float4( panner205, 0, 0.0) ).r;
			float2 appendResult2_g26 = (float2(ase_worldPos.x , ase_worldPos.z));
			float2 appendResult213 = (float2(_TillingX2 , _TillingY2));
			float2 temp_output_6_0_g26 = ( ( appendResult2_g26 * appendResult213 ) + float2( 0,0 ) );
			float2 UVWorld2212 = temp_output_6_0_g26;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_8_0_g28 = ase_worldPos;
			float3 normalizeResult5_g28 = normalize( cross( ddy( temp_output_8_0_g28 ) , ddx( temp_output_8_0_g28 ) ) );
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 worldToTangentPos7_g28 = mul( ase_worldToTangent, normalizeResult5_g28);
			float3 Normal111 = ( UnpackScaleNormal( tex2D( _NormalWaves, uv_NormalWaves77 ), _ScaleNormal ) + ( worldToTangentPos7_g28 * _Facet ) );
			o.Normal = Normal111;
			float2 appendResult2_g27 = (float2(ase_worldPos.x , ase_worldPos.z));
			float2 appendResult47 = (float2(_TillingX , _TillingY));
			float2 temp_output_6_0_g27 = ( ( appendResult2_g27 * appendResult47 ) + float2( 0,0 ) );
			...
			float temp_output_125_0 = ( 1.0 - saturate( ( ( ( eyeDepth100 - i.eyeDepth ) + (-5.0 + (_Depth - 0.0) * (5.0 - -5.0) / (1.0 - 0.0)) ) * -0.2 ) ) );
			...
			float grayscale10_g28 = Luminance(worldToTangentPos7_g28);
			float Emission112 = ( grayscale10_g28 * _Facet );
...
/*ASEBEGIN
Version=18301
0;397;953;292;2619.043;-2906.042;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;116;-4193.633,2496.372;Inherit;False;Property;_RefractionStrength;Refraction Strength;5;0;Create;True;0;0;False;0;False;0;0.18;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;41;-4200.79,451.2031;Inherit;False;Property;_TillingX;Tilling X;18;0;Create;True;0;0;False;0;False;0.66;0.005;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;211;-3862.22,637.135;Inherit;False;UV World;-1;;26;1956765fd0afe43439f5eb3f4e9fd15d;0;2;4;FLOAT2;0,0;False;7;FLOAT2;0,0;False;3;FLOAT2;0;FLOAT;9;FLOAT;10
...
Node;AmplifyShaderEditor.FunctionNode;40;-3873.237,466.5197;Inherit;False;UV World;-1;;27;1956765fd0afe43439f5eb3f4e9fd15d;0;2;4;FLOAT2;0,0;False;7;FLOAT2;0,0;False;3;FLOAT2;0;FLOAT;9;FLOAT;10
...
Node;AmplifyShaderEditor.RangedFloatNode;105;-2187.3,2273.051;Inherit;False;Property;_Depth;Depth;2;0;Create;True;0;0;False;0;False;0;0.06;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ScreenColorNode;118;-3522.283,2434.353;Inherit;False;Global;_GrabScreen0;Grab Screen 0;14;0;Create;True;0;0;False;0;False;Object;-1;False;False;1;0;FLOAT2;0,0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;240;-1776.849,2262.189;Inherit;False;Constant;_Float1;Float 1;19;0;Create;True;0;0;False;0;False;-0.2;-0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;125;-1408.724,2139.45;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;126;-1213.79,2291.274;Inherit;False;Depth;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;78;-6549.417,1316.588;Inherit;False;Property;_ScaleNormal;Scale Normal;7;0;Create;True;0;0;False;0;False;1;0.174;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;151;-6229.247,1573.998;Inherit;False;Property;_Facet;Facet;6;0;Create;True;0;0;False;0;False;0;0.515;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;81;-6279.103,1461.295;Inherit;False;NewLowPolyStyle;-1;;28;9366fbf697958664ea2b821af5ab3369;0;1;8;FLOAT3;0,0,0;False;2;FLOAT;9;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;248;-993.6106,2237.252;Inherit;False;Property;_Float0;Float 0;19;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;262;-2038.57,3008.751;Inherit;False;Property;_DepthOpacity;DepthOpacity;21;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;258;-2035.895,3103.975;Inherit;False;Property;_MainOpacity;Main Opacity;20;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;51;-878.2654,1340.042;Inherit;False;InstancedProperty;_IntensityWaves;Intensity Waves;9;0;Create;True;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;79;-1113.899,190.672;Inherit;False;Property;_MainColor;Main Color;10;0;Create;True;0;0;False;0;False;0,0,0,0;0,0.6447017,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;85;-1136.822,363.886;Inherit;False;Property;_WavesColor;Waves Color;11;0;Create;True;0;0;False;0;False;0,0,0,0;0,0.4955547,0.7924528,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;228;-228.7273,1168.363;Inherit;False;227;Opacity;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;158;-2067.968,2500.662;Inherit;False;Property;_DepthFoam;Depth Foam;0;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;142;-333.6358,927.5899;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;6.140903,959.698;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;Effects/Water/Ocean;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;False;0;True;Transparent;;Transparent;All;14;all;True;True;True;True;0;False;-1;True;2;False;-1;255;False;-1;255;False;-1;6;False;-1;1;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;1;1;5;15;False;0.5;False;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=51DBF2CF5577D5390DFF6F417BC44EEA24E1D34B