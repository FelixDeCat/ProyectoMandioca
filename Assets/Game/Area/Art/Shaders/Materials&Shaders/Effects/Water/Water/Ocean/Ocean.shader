...
#define _IntensityWaves_arr EffectsWaterOcean
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 appendResult2_g25 = (float2(ase_worldPos.x , ase_worldPos.z));
			float2 appendResult47 = (float2(_TillingX , _TillingY));
			float2 temp_output_6_0_g25 = ( ( appendResult2_g25 * appendResult47 ) + float2( 0,0 ) );
			float2 UVWorld57 = temp_output_6_0_g25;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_8_0_g27 = ase_worldPos;
			float3 normalizeResult5_g27 = normalize( cross( ddy( temp_output_8_0_g27 ) , ddx( temp_output_8_0_g27 ) ) );
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 worldToTangentPos7_g27 = mul( ase_worldToTangent, normalizeResult5_g27);
			float3 Normal111 = ( UnpackScaleNormal( tex2D( _NormalWaves, uv_NormalWaves77 ), _ScaleNormal ) + ( worldToTangentPos7_g27 * _Facet ) );
			o.Normal = Normal111;
			float2 appendResult2_g25 = (float2(ase_worldPos.x , ase_worldPos.z));
			float2 appendResult47 = (float2(_TillingX , _TillingY));
			float2 temp_output_6_0_g25 = ( ( appendResult2_g25 * appendResult47 ) + float2( 0,0 ) );
			...
			float grayscale10_g27 = Luminance(worldToTangentPos7_g27);
			float Emission112 = ( grayscale10_g27 * _Facet );
...
/*ASEBEGIN
Version=18301
0;384;949;305;2617.043;-2899.542;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;40;-3873.237,466.5197;Inherit;False;UV World;-1;;25;1956765fd0afe43439f5eb3f4e9fd15d;0;2;4;FLOAT2;0,0;False;7;FLOAT2;0,0;False;3;FLOAT2;0;FLOAT;9;FLOAT;10
...
Node;AmplifyShaderEditor.RangedFloatNode;151;-6229.247,1573.998;Inherit;False;Property;_Facet;Facet;6;0;Create;True;0;0;False;0;False;0;0.568;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;81;-6279.103,1461.295;Inherit;False;NewLowPolyStyle;-1;;27;9366fbf697958664ea2b821af5ab3369;0;1;8;FLOAT3;0,0,0;False;2;FLOAT;9;FLOAT3;0
...
ASEEND*/
//CHKSM=1AC730C316080FAC55D60A62D54C725237903BC3