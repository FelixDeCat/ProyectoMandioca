...
#define _IntensityWaves_arr EffectsWaterOcean
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_8_0_g30 = ase_worldPos;
			float3 normalizeResult5_g30 = normalize( cross( ddy( temp_output_8_0_g30 ) , ddx( temp_output_8_0_g30 ) ) );
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 worldToTangentPos7_g30 = mul( ase_worldToTangent, normalizeResult5_g30);
			float3 Normal111 = ( UnpackScaleNormal( tex2D( _NormalWaves, uv_NormalWaves77 ), _ScaleNormal ) + ( worldToTangentPos7_g30 * _Facet ) );
			o.Normal = Normal111;
			float2 appendResult2_g29 = (float2(ase_worldPos.x , ase_worldPos.z));
			float2 appendResult47 = (float2(_TillingX , _TillingY));
			float2 temp_output_6_0_g29 = ( ( appendResult2_g29 * appendResult47 ) + float2( 0,0 ) );
			...
			float grayscale10_g30 = Luminance(worldToTangentPos7_g30);
			float Emission112 = ( grayscale10_g30 * _Facet );
...
/*ASEBEGIN
Version=18900
0;455;1155;366;1414.682;-1958.147;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;81;-6279.103,1461.295;Inherit;False;NewLowPolyStyle;-1;;30;9366fbf697958664ea2b821af5ab3369;0;1;8;FLOAT3;0,0,0;False;2;FLOAT;9;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;193;-706.6218,460.9494;Inherit;False;Property;_FoamColor;Foam Color;13;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.5754717,0.5754717,0.5754717,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.GetLocalVarNode;190;-696.2242,618.4315;Inherit;False;160;FoamMask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;264;-161.5368,897.6511;Inherit;False;Property;_Color0;Color 0;22;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=CD3C93700751426DE8658ACEFC2877DB20AB25B4