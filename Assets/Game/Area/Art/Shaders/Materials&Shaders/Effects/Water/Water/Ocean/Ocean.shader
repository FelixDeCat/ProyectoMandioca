...
#define _IntensityWaves_arr EffectsWaterOcean
		...
		{
			float2 panner205 = ( 1.0 * _Time.y * float2( 0.01,0 ) + v.texcoord.xy);
			float Noise202 = tex2Dlod( _WavesTexture, float4( panner205, 0, 0.0) ).r;
			float2 panner208 = ( 1.0 * _Time.y * float2( -0.01,0 ) + v.texcoord.xy);
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 Normal111 = BlendNormals( UnpackScaleNormal( tex2D( _NormalWaves, uv_NormalWaves77 ), _ScaleNormal ) , ( worldToTangentPos7_g18 * _Facet ) );
			o.Normal = Normal111;
			float2 panner205 = ( 1.0 * _Time.y * float2( 0.01,0 ) + i.uv_texcoord);
			float Noise202 = tex2D( _WavesTexture, panner205 ).r;
			float2 panner208 = ( 1.0 * _Time.y * float2( -0.01,0 ) + i.uv_texcoord);
			...
			float eyeDepth7_g17 = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, ase_screenPosNorm.xy ));
			float2 temp_output_21_0_g17 = ( (UnpackScaleNormal( tex2D( _NormalRefraction, panner199 ), 0.5 )).xy * ( _RefractionStrength / max( ase_screenDepth , 0.1 ) ) * saturate( ( eyeDepth7_g17 - ase_screenDepth ) ) );
			float eyeDepth26_g17 = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, ( float4( temp_output_21_0_g17, 0.0 , 0.0 ) + ase_screenPosNorm ).xy ));
			float2 temp_output_15_0_g17 = (( float4( ( temp_output_21_0_g17 * saturate( ( eyeDepth26_g17 - ase_screenDepth ) ) ), 0.0 , 0.0 ) + ase_screenPosNorm )).xy;
			float2 temp_output_10_0_g17 = ( ( floor( ( temp_output_15_0_g17 * (_CameraDepthTexture_TexelSize).zw ) ) + 0.5 ) * (_CameraDepthTexture_TexelSize).xy );
			float2 temp_output_109_0 = temp_output_10_0_g17;
			...
			float Emission112 = ( grayscale10_g18 * _Facet );
...
/*ASEBEGIN
Version=18301
0;378;923;311;3794.571;207.4227;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;109;-3944.185,2455.337;Inherit;False;DepthMaskRefraction;-1;;17;61527528047409b4d97706299350589d;2,27,0,4,0;2;18;FLOAT3;0,0,0;False;29;FLOAT;0.02;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;208;-3238.954,28.84828;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;-0.01,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PannerNode;205;-3194.108,-143.7682;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0.01,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;201;-3005.292,-164.407;Inherit;True;Property;_WavesTexture;Waves Texture;16;1;[NoScaleOffset];Create;True;0;0;False;0;False;-1;None;ca76fae7bbd7b7f46aa9d9b3463c6b37;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.CommentaryNode;144;-6599.417,1222.713;Inherit;False;1295.408;421.7906;Comment;10;78;82;81;77;112;80;111;150;151;220;Normal;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;151;-6229.247,1573.998;Inherit;False;Property;_Facet;Facet;9;0;Create;True;0;0;False;0;False;0;0.025;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;78;-6549.417,1316.588;Inherit;False;Property;_ScaleNormal;Scale Normal;10;0;Create;True;0;0;False;0;False;1;0.01050666;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;184;-1389.661,2341.214;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;81;-6269.603,1466.995;Inherit;False;NewLowPolyStyle;-1;;18;9366fbf697958664ea2b821af5ab3369;0;1;8;FLOAT3;0,0,0;False;2;FLOAT;9;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;51;-663.9429,1366.303;Inherit;False;InstancedProperty;_IntensityWaves;Intensity Waves;12;0;Create;True;0;0;False;0;False;0;3.2;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=2F2A781092BDCE1F5FB1F6ABAB0AE2754AAE0CB3