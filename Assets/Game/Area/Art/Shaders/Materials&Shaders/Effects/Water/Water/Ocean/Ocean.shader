...
#define _IntensityWaves_arr EffectsWaterOcean
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 appendResult2_g23 = (float2(ase_worldPos.x , ase_worldPos.z));
			float2 appendResult47 = (float2(_TillingX , _TillingY));
			float2 temp_output_6_0_g23 = ( ( appendResult2_g23 * appendResult47 ) + float2( 0,0 ) );
			float2 UVWorld57 = temp_output_6_0_g23;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_8_0_g25 = ase_worldPos;
			float3 normalizeResult5_g25 = normalize( cross( ddy( temp_output_8_0_g25 ) , ddx( temp_output_8_0_g25 ) ) );
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 worldToTangentPos7_g25 = mul( ase_worldToTangent, normalizeResult5_g25);
			float3 Normal111 = ( UnpackScaleNormal( tex2D( _NormalWaves, uv_NormalWaves77 ), _ScaleNormal ) + ( worldToTangentPos7_g25 * _Facet ) );
			o.Normal = Normal111;
			float2 appendResult2_g23 = (float2(ase_worldPos.x , ase_worldPos.z));
			float2 appendResult47 = (float2(_TillingX , _TillingY));
			float2 temp_output_6_0_g23 = ( ( appendResult2_g23 * appendResult47 ) + float2( 0,0 ) );
			...
			float grayscale10_g25 = Luminance(worldToTangentPos7_g25);
			float Emission112 = ( grayscale10_g25 * _Facet );
...
Node;AmplifyShaderEditor.RangedFloatNode;116;-4193.633,2496.372;Inherit;False;Property;_RefractionStrength;Refraction Strength;5;0;Create;True;0;0;False;0;False;0;0.218;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;40;-3873.237,466.5197;Inherit;False;UV World;-1;;23;1956765fd0afe43439f5eb3f4e9fd15d;0;2;4;FLOAT2;0,0;False;7;FLOAT2;0,0;False;3;FLOAT2;0;FLOAT;9;FLOAT;10
...
Node;AmplifyShaderEditor.FunctionNode;81;-6279.103,1461.295;Inherit;False;NewLowPolyStyle;-1;;25;9366fbf697958664ea2b821af5ab3369;0;1;8;FLOAT3;0,0,0;False;2;FLOAT;9;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;51;-878.2654,1340.042;Inherit;False;InstancedProperty;_IntensityWaves;Intensity Waves;9;0;Create;True;0;0;False;0;False;0;0.6;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=FF5FA5A400FA58EA29A9EBA51B9E5FEA628A9F59