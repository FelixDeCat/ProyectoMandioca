...
#define _IntensityWaves_arr EffectsWaterOcean
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 appendResult2_g28 = (float2(ase_worldPos.x , ase_worldPos.z));
			float2 appendResult213 = (float2(_TillingX2 , _TillingY2));
			float2 temp_output_6_0_g28 = ( ( appendResult2_g28 * appendResult213 ) + float2( 0,0 ) );
			float2 UVWorld2212 = temp_output_6_0_g28;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_output_8_0_g29 = ase_worldPos;
			float3 normalizeResult5_g29 = normalize( cross( ddy( temp_output_8_0_g29 ) , ddx( temp_output_8_0_g29 ) ) );
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 worldToTangentPos7_g29 = mul( ase_worldToTangent, normalizeResult5_g29);
			float3 Normal111 = ( UnpackScaleNormal( tex2D( _NormalWaves, uv_NormalWaves77 ), _ScaleNormal ) + ( worldToTangentPos7_g29 * _Facet ) );
			o.Normal = Normal111;
			float2 appendResult2_g27 = (float2(ase_worldPos.x , ase_worldPos.z));
			float2 appendResult47 = (float2(_TillingX , _TillingY));
			float2 temp_output_6_0_g27 = ( ( appendResult2_g27 * appendResult47 ) + float2( 0,0 ) );
			...
			float grayscale10_g29 = Luminance(worldToTangentPos7_g29);
			float Emission112 = ( grayscale10_g29 * _Facet );
			float4 temp_output_263_0 = ( lerpResult84 + ( DepthOneMinus108 + Emission112 ) );
...
/*ASEBEGIN
Version=18900
0;442;1149;379;712.0396;-893.6243;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;211;-3862.22,637.135;Inherit;False;UV World;-1;;28;1956765fd0afe43439f5eb3f4e9fd15d;0;2;4;FLOAT2;0,0;False;7;FLOAT2;0,0;False;3;FLOAT2;0;FLOAT;9;FLOAT;10
...
Node;AmplifyShaderEditor.FunctionNode;81;-6279.103,1461.295;Inherit;False;NewLowPolyStyle;-1;;29;9366fbf697958664ea2b821af5ab3369;0;1;8;FLOAT3;0,0,0;False;2;FLOAT;9;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;262;-2038.57,3008.751;Inherit;False;Property;_DepthOpacity;DepthOpacity;21;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;258;-2035.895,3103.975;Inherit;False;Property;_MainOpacity;Main Opacity;20;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;193;-706.6218,460.9494;Inherit;False;Property;_FoamColor;Foam Color;13;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0.7187757,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;264;-225.0836,882.9865;Inherit;False;Property;_Color0;Color 0;22;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleAddOpNode;263;-207.3844,714.0399;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=6E77689BE03C80965FFBC28BE61B1E5FAB39B617