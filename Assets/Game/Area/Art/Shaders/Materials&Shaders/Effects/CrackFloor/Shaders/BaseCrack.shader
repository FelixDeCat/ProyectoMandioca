...
#define _CrackMaskValue_arr StyleNewBaseCrack
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 uv_NormalCrack136 = i.uv_texcoord;
			float3 NormalCrack89 = UnpackScaleNormal( tex2D( _NormalCrack, uv_NormalCrack136 ), _NormalCrackStrength );
			float _CrackMaskValue_Instance = UNITY_ACCESS_INSTANCED_PROP(_CrackMaskValue_arr, _CrackMaskValue);
			float2 uv_CrackMask120 = i.uv_texcoord;
			...
			float ValueCrack92 = ( _CrackMaskValue_Instance * saturate( ( ( tex2D( _CrackMask, uv_CrackMask120 ).r * ( 1.0 - tex2D( _Mask, temp_output_6_0_g13 ).r ) ) * (0.0 + (_MaskCrack - 0.0) * (200.0 - 0.0) / (1.0 - 0.0)) ) ) );
			...
			float2 uv_CrackTexture128 = i.uv_texcoord;
			float smoothstepResult64 = smoothstep( 0.0 , _CrackHardness , tex2D( _CrackTexture, uv_CrackTexture128 ).r);
...
/*ASEBEGIN
Version=18900
0;438;1120;383;2962.831;-1624.911;1;True;False
Node;AmplifyShaderEditor.Vector2Node;145;-3438.952,2333.048;Inherit;False;Property;_Vector1;Vector 1;26;0;Create;True;0;0;0;False;0;False;0.1,0.1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;120;-2814.045,2152.998;Inherit;True;Property;_CrackMask;CrackMask;21;2;[Header];[NoScaleOffset];Create;True;1;Textures;0;0;False;0;False;-1;None;713e120de4714974ebee792e88d1d123;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;123;-2608.807,2479.277;Inherit;False;Property;_MaskCrack;Mask Crack;20;0;Create;True;0;0;0;False;0;False;0;0.661;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;65;-3184.654,1775.111;Inherit;False;Property;_CrackHardness;Crack Hardness;17;1;[Header];Create;True;1;Sliders;0;0;False;0;False;0;0.4770565;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=992E70F93FD79E8FFC91343141B419B7AB5051CD