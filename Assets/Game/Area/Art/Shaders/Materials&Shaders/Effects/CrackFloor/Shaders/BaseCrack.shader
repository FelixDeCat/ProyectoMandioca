...
Shader "Style/New/BaseCrack"
{
	Properties
	{
		...
		_CrackTilling("CrackTilling", Vector) = (0,0,0,0)
...
#define _CrackMaskValue_arr StyleNewBaseCrack
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 LowPolyNormal11_g14 = worldToTangentPos7_g15;
			float3 normalizeResult5_g14 = normalize( LowPolyNormal11_g14 );
			float2 uv_Normal3 = i.uv_texcoord;
			float3 Normal10 = UnpackNormal( tex2D( _Normal, uv_Normal3 ) );
			float3 Normal9_g14 = BlendNormals( normalizeResult5_g14 , Normal10 );
			float4 lerpResult37 = lerp( color35 , float4( Normal9_g14 , 0.0 ) , _NormalValue);
			float2 uv_TexCoord148 = i.uv_texcoord * _CrackTilling;
			float3 NormalCrack89 = UnpackScaleNormal( tex2D( _NormalCrack, uv_TexCoord148 ), _NormalCrackStrength );
			...
			float2 temp_output_6_0_g13 = ( ( appendResult2_g13 * _Vector1 ) + float2( 0,0 ) );
			float ValueCrack92 = ( _CrackMaskValue_Instance * saturate( ( ( tex2D( _CrackMask, uv_TexCoord148 ).r * ( 1.0 - tex2D( _Mask, temp_output_6_0_g13 ).r ) ) * (0.0 + (_MaskCrack - 0.0) * (200.0 - 0.0) / (1.0 - 0.0)) ) ) );
			...
			float smoothstepResult64 = smoothstep( 0.0 , _CrackHardness , tex2D( _CrackTexture, uv_TexCoord148 ).r);
			...
			float3 Emission46_g14 = ( Emission14.rgb * EmissionIntensity12 );
			#ifdef _USEEMISSION_ON
				float3 staticSwitch43 = saturate( Emission46_g14 );
			#else
			...
			float temp_output_39_0_g14 = Smoothness9;
			float Smoothness43_g14 = ( temp_output_39_0_g14 * SmoothnessValue13 );
			#ifdef _USESMOOTHNESS_ON
				float staticSwitch48 = saturate( Smoothness43_g14 );
			#else
			...
			float AO66_g14 = AmbientOcclusionTexturet11;
			o.Occlusion = pow( AO66_g14 , _AOIntensity );
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18900
0;453;1155;368;5949.381;238.1744;6.159895;True;False
Node;AmplifyShaderEditor.Vector2Node;145;-3438.952,2333.048;Inherit;False;Property;_Vector1;Vector 1;27;0;Create;True;0;0;0;False;0;False;0.1,0.1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;149;-3583.417,1611.605;Inherit;False;Property;_CrackTilling;CrackTilling;17;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;143;-2907.427,2408.997;Inherit;True;Property;_Mask;Mask;26;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;c8c801559acc26941845f197479ce060;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;148;-3428.417,1595.605;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;120;-2813.045,2152.998;Inherit;True;Property;_CrackMask;CrackMask;22;2;[Header];[NoScaleOffset];Create;True;1;Textures;0;0;False;0;False;-1;None;713e120de4714974ebee792e88d1d123;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;123;-2608.807,2479.277;Inherit;False;Property;_MaskCrack;Mask Crack;21;0;Create;True;0;0;0;False;0;False;0;0.661;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;65;-3184.654,1775.111;Inherit;False;Property;_CrackHardness;Crack Hardness;18;1;[Header];Create;True;1;Sliders;0;0;False;0;False;0;0.4770565;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;8;-3030.339,-491.6544;Inherit;True;Property;_Albedo;Albedo;2;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;c1970ddf709cd664f8ffab42a7ecd550;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;79;-2729.322,1863.65;Inherit;False;Property;_NormalCrackStrength;NormalCrackStrength;19;0;Create;True;0;0;0;False;0;False;0;0.219;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;81;-2359.809,2083.87;Inherit;False;InstancedProperty;_CrackMaskValue;CrackMaskValue;20;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1;-713.3684,36.53974;Inherit;False;Base;-1;;14;7fb924c0b3c46a84fb4eaa069d41dc90;0;7;74;FLOAT;0;False;67;FLOAT;0;False;50;FLOAT3;0,0,0;False;52;FLOAT;0;False;39;FLOAT;0;False;42;FLOAT;0;False;4;FLOAT3;0,0,0;False;5;FLOAT;69;FLOAT;64;FLOAT3;48;FLOAT;35;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;58;-2499.181,353.0496;Inherit;False;Property;_ColorCrack;Color Crack;16;1;[Header];Create;True;1;Crack Parameters;0;0;False;0;False;1,0,0,0;0.6132076,0.6132076,0.6132076,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;142;-3781.049,2219.213;Inherit;False;Property;_Offset;Offset;25;1;[Header];Create;True;1;Crack UV;0;0;False;0;False;0,0;0.4,-0.82;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;138;-3177.624,2539.086;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;140;-3551.777,2147.944;Inherit;False;UV World;-1;;16;1956765fd0afe43439f5eb3f4e9fd15d;0;2;4;FLOAT2;0,0;False;7;FLOAT2;0,0;False;3;FLOAT2;0;FLOAT;9;FLOAT;10
...
ASEEND*/
//CHKSM=33434FF305E7F65214FD6AFF7EFC21F01491C3F0