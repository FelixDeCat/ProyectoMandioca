...
Shader "Effects/Skybox/CustoSkybox"
{
	Properties
	{
		...
		_GroundColor("Ground Color", Color) = (0.8301887,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float2 panner62 = ( 1.0 * _Time.y * float2( 0.1,0 ) + UVSkybox26);
				float smoothstepResult48 = smoothstep( _CloudsIntensity , 1.0 , tex2D( _TextureSample0, panner62 ).r);
...
/*ASEBEGIN
Version=17200
0;408;977;281;803.0875;-343.9561;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-1053.058,84.59409;Inherit;False;Property;_MoveGradiant;MoveGradiant;0;0;Create;True;0;0;False;0;0;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;42;-622.0617,436.7672;Inherit;False;26;UVSkybox;1;0;OBJECT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.PannerNode;62;-283.4195,457.0869;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0.1,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ColorNode;44;399.4917,276.3372;Inherit;False;Property;_CloudsColor;CloudsColor;5;0;Create;True;0;0;False;0;0.7126202,0.9622642,0.9492502,0;0.1084901,0.8182862,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;16;-32.28954,-84.96143;Inherit;False;Property;_SkyColor;Sky Color;1;0;Create;True;0;0;False;0;0.309124,0.7264151,0,0;0.4117647,0.6615295,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;15;41.05364,-276.8385;Inherit;False;Property;_GroundColor;Ground Color;2;0;Create;True;0;0;False;0;0.8301887,0,0,0;1,0.8125,0.5613207,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;55;1209.7,76.82545;Inherit;False;Property;_IntensitySkyBox;IntensitySkyBox;6;0;Create;True;0;0;False;0;0;0.422;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=4D8BFA4A2BD97D54581568AA165EA28C42736050