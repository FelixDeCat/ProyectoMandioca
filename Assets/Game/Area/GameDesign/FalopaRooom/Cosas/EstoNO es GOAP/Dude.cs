...
namespace GOAP
{
    ...
    public class Dude : MonoBehaviour
    {
        ...
        public void Initialize()
        {
            ...
            void Think () {_fsm.Feed(ActionEntity.NextStep);};
            ...
            {
                _ent.GoTo(_target.transform.position);
                _ent.OnReachDestinationNoParameters += Think;
            };
        ...
        {
            if (Vector3.Distance(_target.transform.position, _ent.transform.position) < 4.5f)
            {
        ...
        {
            if (Vector3.Distance(_target.transform.position, _ent.transform.position) > 2)
            {
                _fsm.Feed(ActionEntity.FailedStep);
                return;
            }
