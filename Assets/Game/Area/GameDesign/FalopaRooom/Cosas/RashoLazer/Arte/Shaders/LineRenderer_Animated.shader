...
Shader "LineRenderer_Animated"
{
	Properties
	{
		...
		[HDR]_BeamOutline("BeamOutline", Color) = (0.6722143,1.529545,1.566038,0)
		_Float1("Float 1", Range( 0 , 2)) = 1.94
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 uv_TexCoord20 = i.uv_texcoord * float2( 3,1 ) + ( appendResult16 * _Time.y ).xy;
			...
			float BeamAlpha76 = tex2DNode25.a;
			float temp_output_6_0_g1 = saturate( pow( ( 1.0 - BeamAlpha76 ) , 0.16 ) );
			float temp_output_19_0_g1 = _Float1;
			float4 Outline68 = ( ( step( temp_output_6_0_g1 , temp_output_19_0_g1 ) - step( temp_output_6_0_g1 , ( temp_output_19_0_g1 / 2.0 ) ) ) * _BeamOutline * 1.0 );
			float mulTime62 = _Time.y * -0.5;
			float2 temp_cast_3 = (mulTime62).xx;
			...
			float mulTime94 = _Time.y * 3.51;
			float PulsatingMask101 = saturate( ( 1.0 - ( ( temp_output_95_0 * temp_output_95_0 * ( ( sin( mulTime94 ) + 1.54 ) * 4.17 ) ) * 8.9 ) ) );
...
/*ASEBEGIN
Version=18301
343;81;815;498;3315.9;-725.2241;1.995716;True;False
Node;AmplifyShaderEditor.CommentaryNode;70;-2468.752,-135.9585;Inherit;False;1193.172;695.7385;Rayitos Distortion;11;14;13;16;15;17;20;52;21;55;19;22;;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-2418.752,252.3793;Inherit;False;Property;_FoamYdir;Foam Y dir;6;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-2411.299,168.1814;Inherit;False;Property;_FoamXdir;Foam X dir;5;0;Create;True;0;0;False;0;False;0;-3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;15;-2275.893,365.4897;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;94;-3413.61,1118.773;Inherit;False;1;0;FLOAT;3.51;False;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode;96;-3197.212,1134.247;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;25;-1773.887,-665.3258;Inherit;True;Property;_Beam;Beam;9;0;Create;True;0;0;False;0;False;-1;None;d417b6b65d1f1f04490f3f9446be94df;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;19;-1923.116,232.5461;Inherit;True;Property;_flowmap;flowmap;7;0;Create;True;0;0;False;0;False;-1;b228256564010e548987d7bd1b4c5b7d;b228256564010e548987d7bd1b4c5b7d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;21;-1740.929,443.7799;Inherit;False;Property;_Flowmapinten;Flow map inten;8;0;Create;True;0;0;False;0;False;0;0.098;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;41;-1231.288,1404.391;Inherit;False;Property;_BeamOutline;BeamOutline;11;1;[HDR];Create;True;0;0;False;0;False;0.6722143,1.529545,1.566038,0;0.3635047,1.885681,7.005727,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;47;-950.7667,1477.773;Inherit;False;Constant;_Float3;Float 3;9;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;45;-1219.633,1312.721;Inherit;False;Constant;_Float2;Float 2;9;0;Create;True;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;44;-1255.197,1214.974;Inherit;False;Property;_Float1;Float 1;12;0;Create;True;0;0;False;0;False;1.94;1.03;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;43;-1210.431,1134.677;Inherit;False;Constant;_Float0;Float 0;9;0;Create;True;0;0;False;0;False;0.16;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;64;-661.9305,748.2875;Inherit;False;Constant;_Float4;Float 4;13;0;Create;True;0;0;False;0;False;-0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;42;-732.3011,1125.501;Inherit;True;OutlineFromMask;1;;1;ea9dea216bffc224b869eb4709f2ec2e;0;6;17;FLOAT;0;False;18;FLOAT;1;False;19;FLOAT;1;False;20;FLOAT;1;False;22;COLOR;1,0,0,0;False;23;FLOAT;1;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleTimeNode;62;-486.9409,686.928;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;58;-714.305,162.3409;Inherit;False;Property;_CenterTint;CenterTint;10;1;[HDR];Create;True;0;0;False;0;False;0.6722143,1.529545,1.566038,0;0.07643212,0.6634359,5.401213,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;1;-1776.571,-908.8492;Inherit;True;Property;_MainText;MainText;3;0;Create;True;0;0;False;0;False;-1;None;2562e043a4171244295217a10b038938;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;89;-288.4232,360.0482;Inherit;False;Property;_SecondaryBeamTint;SecondaryBeamTint;13;0;Create;True;0;0;False;0;False;0.9528302,0,0,0;0.4708081,0.7369546,0.8679245,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;2;-359.1528,-331.1889;Inherit;False;Property;_Tint;Tint;4;0;Create;True;0;0;False;0;False;0,0,0,0;0.3920879,0.697124,0.8396226,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1502.66,242.0149;Float;False;True;-1;2;ASEMaterialInspector;0;0;Unlit;LineRenderer_Animated;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;0;True;Transparent;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;42;17;77;0
WireConnection;42;18;43;0
WireConnection;42;19;44;0
WireConnection;42;20;45;0
WireConnection;42;22;41;0
WireConnection;42;23;47;0
...
ASEEND*/
//CHKSM=1C25EAEB53F51BCAE5210F64EE910DA95DC1BBAA