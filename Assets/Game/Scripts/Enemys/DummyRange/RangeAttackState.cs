...
{
    public class RangeAttackState : DummyEnemyStates
    {
        float cd;
        float timer;
        ICombatDirector enemy;
        public RangeAttackState(EState<TrueDummyEnemy.DummyEnemyInputs> myState, EventStateMachine<TrueDummyEnemy.DummyEnemyInputs> _sm,
