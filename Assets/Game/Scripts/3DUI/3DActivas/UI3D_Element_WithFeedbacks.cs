...
public class UI3D_Element_WithFeedbacks : UI3D_Element
{
    ...
    protected override void Custom_UI_Event_OnSelect() { base.Custom_UI_Event_OnSelect(); foreach (var f in feedbacks) f.Show(); }
    protected override void Custom_UI_Event_OnDeselect() { base.Custom_UI_Event_OnDeselect(); foreach (var f in feedbacks) f.Hide(); }
    protected override void Custom_UI_Event_OnSubmit() { base.Custom_UI_Event_OnSubmit(); foreach (var f in feedbackOnSelect) f.Execute(); }
